...
namespace Bespoke.Sph.Domain
{
    ...
    public partial class WorkflowForm : Entity
    {
        ...
        public async Task<BuildValidationResult> ValidateBuildAsync(WorkflowDefinition ed)
        {
        ...
        [JsonIgnore]
        public string Url => $"workflow.form.designer/{Id}";
    }
}