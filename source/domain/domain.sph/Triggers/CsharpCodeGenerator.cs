...
namespace Bespoke.Sph.Domain
{
    public class CsharpCodeGenerator
    {
        ...
        public string GetClassDefinition(string elementOrComplexType)
        {
            ...
            code.AppendLinf("   public partial class {0} : {1}", name, baseClass);
            code.AppendLine("   {");
        ...
        private IEnumerable<string> GetMembers(XElement ct)
        {
            ...
            if (null != all)
            {
                ...
                var allElements = from at in all.Elements(x + "element")
                                  ...
                                  select string.Format("      public {1} {0} {{get;set;}}", at.Attribute("name").Value, WorkflowDefinition.GetClrDataType(at));
