...
namespace Bespoke.Sph.Domain.Api
{
    ...
    public class ChildListActionCode : ControllerAction
    {
        ...
        private string GenerateChildListAction(TableDefinition table, Adapter adapter, TableDefinition child)
        {
            ...
            var routes = pks.Select(k => k + this.GetRouteConstraint(k.Type));
           ...
           if (size > 200)
            ...
            ", adapter.OdataTranslator, child.Name, child.Schema, child.Name.ToLowerInvariant(), child.Schema.ToLowerInvariant());
