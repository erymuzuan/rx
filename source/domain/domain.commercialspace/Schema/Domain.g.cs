	  ...
	  namespace Bespoke.SphCommercialSpaces.Domain
	  {
          ...
          public  partial class Land
          {
			...
			OnPropertyChanged(PropertyNameAddress);
                ...
                [DebuggerHidden]
                    ...
                    set
                    {
                    if( /* if nillable use ?? 0d temp */ Math.Abs(m_size - value) < 0.00001d) return;
          ...
          public  partial class LatLng
          {
                ...
                [DebuggerHidden]
                    ...
                    set
                    {
                    if( /* if nillable use ?? 0d temp */ Math.Abs(m_lat - value) < 0.00001d) return;
                ...
                [DebuggerHidden]
                    ...
                    set
                    {
                    if( /* if nillable use ?? 0d temp */ Math.Abs(m_lng - value) < 0.00001d) return;
                ...
                set
                {
                if(/* if nillable use ?? 0d temp */ Math.Abs((double) (m_elevation - value)) < 0.00001d) return;
          ...
          public  partial class ContractTemplate
          {
			...
			get{ return m_TopicCollection;}
                ...
                [DebuggerHidden]
                    ...
                    set
                    {
                    if( /* if nillable use ?? 0d temp */ Math.Abs(m_interestRate - value) < 0.00001d) return;
      ...
      // public properties members
        ...
        OnPropertyChanged(PropertyNameCustomActionId);
        }
        }
        get
        {
