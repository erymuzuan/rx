    ...
    namespace Bespoke.SphCommercialSpaces.Domain
    {
          ...
          public  partial class ReportFilter
          {
                    ...
                    public const string PropertyNameParameterName = "ParameterName";
                ...
                [DebuggerHidden]
                    ...
                    set
                    {
                    if( String.Equals( m_parameterName, value, StringComparison.Ordinal)) return;
                    var arg = new PropertyChangingEventArgs(PropertyNameParameterName, value);
                    OnPropertyChanging(arg);
                    if( !arg.Cancel)
                    {
