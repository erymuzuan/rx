...
namespace Bespoke.Station.Domain.QueryProviders
{
    ...
    {
        Dictionary<string, HashSet<string>> m_allColumnsUsed;
        ...
        protected override Expression VisitColumn(ColumnExpression column)
        {
            ...
            if (!this.m_allColumnsUsed.TryGetValue(column.Alias, out columns))
            {
                columns = new HashSet<string>();
                this.m_allColumnsUsed.Add(column.Alias, columns);
            }
        ...
        protected override Expression VisitSelect(SelectExpression select)
        {
            ...
            if (this.m_allColumnsUsed.TryGetValue(select.Alias, out columnsUsed))
            {
        ...
        protected override Expression VisitProjection(ProjectionExpression projection)
        {
            ...
            var source = (SelectExpression)this.Visit(projection.Source);
