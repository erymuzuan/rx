...
namespace ASP
{
    ...
    public partial class _Areas_Sph_Views_Editor_Page_cshtml : System.Web.Mvc.WebViewPage<Bespoke.Sph.Web.ViewModels.EditorPageViewModel>
    {
        public _Areas_Sph_Views_Editor_Page_cshtml()
        {
        }
...
WriteAttribute("href", Tuple.Create(" href=\"", 486), Tuple.Create("\"", 529)
, Tuple.Create(Tuple.Create("", 493), Tuple.Create<System.Object, System.Int32>(Href("~/Content/external/bootstrap.min.css")
, 493), false)
);
...
WriteAttribute("href", Tuple.Create(" href=\"", 561), Tuple.Create("\"", 607)
, Tuple.Create(Tuple.Create("", 568), Tuple.Create<System.Object, System.Int32>(Href("~/Content/external/font-awesome.min.css")
, 568), false)
);
