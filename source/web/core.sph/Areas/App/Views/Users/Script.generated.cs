...
"cs = new $.Deferred();\r\n                loadDetails();\r\n                var prof" +
"ileTask = context.loadAsync(\"UserProfile\", query);\r\n                var designat" +
"ionTask = context.getListAsync(\"Designation\",\"Id ne \'0\'\", \"Name\");\r\n            " +
...
"le().UserName.subscribe(userNameChaged);\r\n                \r\n                $(\'#" +
...
"     vm.password1(\'\');\r\n                vm.password2(\'\');\r\n                var c" +
"1 = ko.mapping.fromJSON(ko.mapping.toJSON(user));\r\n                var clone = c" +
"1;\r\n                vm.profile(clone);\r\n            },\r\n            savePassword" +
" = function() {\r\n                var tcs = new $.Deferred();\r\n                if" +
" (!vm.password1() && !vm.password2()) return tcs.promise();\r\n                if " +
"(vm.password1() != vm.password2()) {\r\n                    logger.logError(\'Passw" +
"ord mismatch\', this, this, true);\r\n                    return tcs.promise();\r\n  " +
"              }\r\n                \r\n                var data = ko.mapping.toJSON(" +
"{userName: vm.profile().UserName(), password: vm.password1}) ;\r\n                " +
