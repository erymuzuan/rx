...
WriteLiteral("\r\n<!--ko if:$data[\'$type\']() === \"Bespoke.Sph.Domain.FileUploadElement, domain.sp" +
"h\" -->\r\n<div class=\"form-group\" data-bind=\"css: { \'selected-form-element\': isSel" +
"ected }, click: $root.selectFormElement\">\r\n    ");
...
Write(Html.Partial("_DesignerContextAction"));
            ...
            #line hidden
WriteLiteral(@"
    <label data-bind=""text: Label"" class=""control-label col-lg-2"">LABEL</label>
    <div class=""col-lg-6"">
        <button data-bind=""attr: { 'class': CssClass() + ' form-control' + ' ' + Size(), 'title': Tooltip }, text:' [ ' + Path() + ' ] '""></button>
