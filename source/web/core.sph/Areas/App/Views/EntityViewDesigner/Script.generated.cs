...
"\r\n                    var columns = _($(\'ul#column-design>li:not(:first)\')).map(" +
"function (div) {\r\n                        return ko.dataFor(div);\r\n             " +
"       });\r\n                    view().ViewColumnCollection(columns);\r\n\r\n       " +
"             var tcs = new $.Deferred(),\r\n                        data = ko.mapp" +
"ing.toJSON(view);\r\n\r\n                    context.post(data, \"/Sph/EntityView/Pub" +
...
"r.error(\"There are errors in your entity, !!!\");\r\n                            }\r" +
"\n\r\n                            tcs.resolve(result);\r\n                        });" +
"\r\n                    return tcs.promise();\r\n                },\r\n               " +
" save = function () {\r\n                    // get the sorted element\r\n          " +
"          var columns = _($(\'ul#column-design>li:not(:first)\')).map(function (di" +
"v) {\r\n                        return ko.dataFor(div);\r\n                    });\r\n" +
"                    view().ViewColumnCollection(columns);\r\n\r\n                   " +
" var tcs = new $.Deferred(),\r\n                        data = ko.mapping.toJSON(v" +
"iew);\r\n\r\n                    context.post(data, \"/Sph/EntityView/Save\")\r\n       " +
"                 .then(function (result) {\r\n                            view().E" +
"ntityViewId(result.id);\r\n                            tcs.resolve(result);\r\n     " +
"                   });\r\n                    return tcs.promise();\r\n             " +
...
"                attached: attached,\r\n                activate: activate,\r\n      " +
"          view: view,\r\n                entity: entity,\r\n                formsQue" +
"ry: ko.computed(function () {\r\n                    return String.format(\"EntityD" +
"efinitionId eq {0}\", entity().EntityDefinitionId());\r\n                }),\r\n     " +
...
"tion () {\r\n                            return view().EntityViewId() > 0 && view(" +
").IsPublished();\r\n                        })\r\n                    }\r\n           " +
"         ]),\r\n                    saveCommand: save\r\n                }\r\n        " +
"    };\r\n\r\n            return vm;\r\n\r\n        });\r\n\r\n\r\n</script>\r\n");
