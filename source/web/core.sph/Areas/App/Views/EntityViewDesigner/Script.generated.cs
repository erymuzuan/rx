...
"                   var columns = _($(\'ul#column-design>li:not(:first)\')).map(fun" +
"ction (div) {\r\n                        return ko.dataFor(div);\r\n                " +
"    });\r\n                    view().ViewColumnCollection(columns);\r\n\r\n          " +
"          var tcs = new $.Deferred(),\r\n                        data = ko.mapping" +
".toJSON(view);\r\n\r\n                    context.post(data, \"/Sph/EntityView/Publis" +
"h\")\r\n                        .then(function (result) {\r\n                        " +
"    if (result.success) {\r\n                                logger.info(result.me" +
"ssage);\r\n                                view().EntityViewId(result.id);\r\n      " +
"                          errors.removeAll();\r\n                                v" +
"iew().IsPublished(true);\r\n                            } else {\r\n                " +
"                errors(result.Errors);\r\n                                logger.e" +
"rror(\"There are errors in your entity, !!!\");\r\n                            }\r\n\r\n" +
"                            tcs.resolve(result);\r\n                        });\r\n " +
"                   return tcs.promise();\r\n                },\r\n                sa" +
"ve = function () {\r\n                    // get the sorted element\r\n             " +
"       var columns = _($(\'ul#column-design>li:not(:first)\')).map(function (div) " +
"{\r\n                        return ko.dataFor(div);\r\n                    });\r\n   " +
"                 view().ViewColumnCollection(columns);\r\n\r\n                    va" +
...
"fo(result.message);\r\n                            errors.removeAll();\r\n          " +
"              } else {\r\n                            logger.error(\"There are erro" +
"rs in your view, !!!\");\r\n                        }\r\n                        tcs." +
"resolve(result);\r\n                    });\r\n                return tcs.promise();" +
"\r\n            };\r\n\r\n            var vm = {\r\n                errors: errors,\r\n   " +
"             attached: attached,\r\n                activate: activate,\r\n         " +
"       view: view,\r\n                entity: entity,\r\n                formsQuery:" +
" ko.computed(function () {\r\n                    return String.format(\"EntityDefi" +
"nitionId eq {0}\", entity().EntityDefinitionId());\r\n                }),\r\n        " +
"        toolbar: {\r\n                    commands: ko.observableArray([{\r\n       " +
"                 caption: \'Clone\',\r\n                        icon: \'fa fa-copy\',\r" +
"\n                        command: function () {\r\n                            vie" +
"w().Name(view().Name() + \' Copy (1)\');\r\n                            view().Route" +
"(\'\');\r\n                            view().EntityViewId(0);\r\n                    " +
...
"n () {\r\n                            return view().EntityViewId() > 0 && view().I" +
"sPublished();\r\n                        })\r\n                    }\r\n              " +
"      ]),\r\n                    saveCommand: save\r\n                }\r\n           " +
" };\r\n\r\n            return vm;\r\n\r\n        });\r\n\r\n\r\n</script>\r\n");
