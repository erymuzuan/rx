...
"= ko.mapping.toJSON(view);\r\n\r\n                    context.post(data, \"/Sph/Entit" +
"yView/Publish\")\r\n                        .then(function (result) {\r\n            " +
"                if (result.success) {\r\n                                logger.in" +
"fo(result.message);\r\n                                view().EntityViewId(result." +
"id);\r\n                                errors.removeAll();\r\n                     " +
...
"ar tcs = new $.Deferred(),\r\n                    data = ko.mapping.toJSON(view);\r" +
"\n\r\n                context.post(data, \"/EntityView/Depublish\")\r\n                " +
"    .then(function (result) {\r\n                        if (result.success) {\r\n  " +
"                          view().IsPublished(false);\r\n                          " +
"  logger.info(result.message);\r\n                            errors.removeAll();\r" +
"\n                        } else {\r\n                            logger.error(\"The" +
"re are errors in your view, !!!\");\r\n                        }\r\n                 " +
"       tcs.resolve(result);\r\n                    });\r\n                return tcs" +
".promise();\r\n            },\r\n            partialEditor = null,\r\n            edit" +
"Code = function () {\r\n                if (null == partialEditor || partialEditor" +
".closed) {\r\n                    var partial = \"partial/\" + view().Route();\r\n    " +
"                partialEditor = window.open(\"/sph/editor/file?id=/sphapp/\" + par" +
"tial + \".js\", \'_blank\', \'height=600px,width=600px,toolbar=0,location=0\');\r\n     " +
...
".format(\"EntityDefinitionId eq {0}\", entity().EntityDefinitionId());\r\n          " +
"      }),\r\n                toolbar: {\r\n                    commands: ko.observab" +
"leArray([{\r\n                        caption: \'Clone\',\r\n                        i" +
"con: \'fa fa-copy\',\r\n                        command: function () {\r\n            " +
