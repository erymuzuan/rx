...
ko.bindingHandlers.workflowFormPathIntellisense={init:function(t,e,n){var i=e(),o=ko.unwrap(i.schema),a=n(),r=function(){var e=$(t),n=$("<div></div>").css({height:"28px"});e.hide().before(n);var i=completely(n[0],{fontSize:"12px",color:"#555;",fontFamily:'"Open Sans", Arial, Helvetica, sans-serif'});i.setText(ko.unwrap(a.value));for(var r in o)if(o.hasOwnProperty(r)){if("$type"===r)continue;if("addChildItem"===r)continue;if("removeChildItem"===r)continue;if("Empty"===r)continue;if("WebId"===r)continue;i.options.push(""+r)}i.options.sort();var p=o;i.onChange=function(t){if(t.lastIndexOf(".")===t.length-1){i.options=[];var e=t.split(".");p=o,_(e).each(function(t){""!==t&&(p=p[t])}),console.log("currentObject",p);for(var n in p)if(p.hasOwnProperty(n)){if("$type"===n)continue;if("addChildItem"===n)continue;if("removeChildItem"===n)continue;if("Empty"===n)continue;if("WebId"===n)continue;i.options.push(""+n)}i.options.sort(),i.startFrom=t.lastIndexOf(".")+1}i.repaint()},i.repaint(),$(i.input).attr("autocomplete","off").blur(function(){a.value($(this).val())}).parent().find("input").css({padding:"6px 12px",height:"28px"}),$(t).prop("required")&&$(i.input).prop("required",!0)};r()}},ko.bindingHandlers.activityClass={init:function(t,e){var n=$(t),i=ko.unwrap(e()),o="function"==typeof i.$type?i.$type():i.$type,a=/Bespoke\.Sph\.Domain\.(.*?),/.exec(o)[1];n.addClass("activity32").addClass("activity32-"+a)}},ko.bindingHandlers.checkedItems={init:function(t,e){var n=ko.dataFor(t),i=e();$(t).change(function(){var t=$(this).is(":checked");t?i.push(n):i.remove(n)})}},ko.bindingHandlers.typeahead={init:function(t,e,n){var i=ko.unwrap(e()),o=n();if("undefined"!=typeof i){var a=new Bloodhound({datumTokenizer:function(t){return Bloodhound.tokenizers.whitespace(t.Path)},queryTokenizer:Bloodhound.tokenizers.nonword,prefetch:"/api/workflow-definitions/"+i+"/variable-path"});a.initialize(),$(t).typeahead({highlight:!0},{name:"schema_paths"+i,displayKey:"Path",source:a.ttAdapter()}).on("typeahead:closed",function(){o.value($(this).val())})}}},ko.bindingHandlers.activityPopover={init:function(t,e){var n=$(t),i=ko.unwrap(e()),o="function"==typeof i.$type?i.$type():i.$type,a=/Bespoke\.Sph\.Domain\.(.*?),/.exec(o)[1],r=ko.dataFor(n.parent()[0]).wd(),p=n.popover({title:a+" : "+i.Name(),html:!0,content:function(){return $("a.edit-activity").popover("hide"),n.find("a.edit-activity").addClass(i.WebId()),n.find("a.delete-activity").addClass(i.WebId()),n.find("a.start-activity").addClass(i.WebId()),n.find("div.context-menu").html()}});p.on("shown.bs.popover",function(){setTimeout(function(){p.popover("hide")},5e3)}),$(document).on("click","a."+i.WebId(),function(t){t.preventDefault();var e=require(objectbuilders.app),n=$(this);n.hasClass("delete-activity")&&e.showMessage("Are you sure you want to remove this Activity","Remove activity",["Yes","No"]).done(function(t){"Yes"===t&&r.removeActivity(i)()}),n.hasClass("edit-activity")&&r.editActivity(i)(),n.hasClass("start-activity")&&r.setStartActivity(i)()})}},ko.bindingHandlers.comboBoxLookupOptions={init:function(t,e){var n=$(t),i=ko.unwrap(e()),o=i.value,a=i.caption,r=require("services/datacontext"),p=ko.unwrap(i.displayPath),s=ko.unwrap(i.valuePath),u=function(e){var u=ko.unwrap(i.valuePath)===ko.unwrap(i.displayPath)?r.getListAsync(ko.unwrap(i.entity),e,ko.unwrap(i.valuePath)):r.getTuplesAsync({entity:ko.unwrap(i.entity),query:e,field:s,field2:p});u.done(function(e){t.options.length=0,a&&t.add(new Option(a,"")),_(e).each(function(e){return"string"==typeof e?void t.add(new Option(e,e)):"string"==typeof e.Item1&&"string"==typeof e.Item2?void t.add(new Option(e.Item2,e.Item1)):"string"==typeof e[s]&&"string"==typeof e[p]?void t.add(new Option(e[s],e[p])):void 0}),n.val(ko.unwrap(o)).on("change",function(){o(n.val())})})};u(ko.unwrap(i.query)),"function"==typeof i.query&&"function"==typeof i.query.subscribe&&i.query.subscribe(function(t){u(ko.unwrap(t))})},update:function(t,e){var n=ko.unwrap(e()),i=n.value;$(t).val(ko.unwrap(i))}};
