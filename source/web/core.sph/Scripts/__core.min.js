...
ko.bindingHandlers.activityClass={init:function(e,t){var n=$(e),i=ko.unwrap(t()),o="function"==typeof i.$type?i.$type():i.$type,a=/Bespoke\.Sph\.Domain\.(.*?),/.exec(o)[1];n.addClass("activity32").addClass("activity32-"+a)}},ko.bindingHandlers.checkedItems={init:function(e,t){var n=ko.dataFor(e),i=t();$(e).change(function(){var e=$(this).is(":checked");e?i.push(n):i.remove(n)})}},ko.bindingHandlers.typeahead={init:function(e,t,n){var i=ko.unwrap(t()),o=n();if("undefined"!=typeof i){var a=new Bloodhound({datumTokenizer:function(e){return Bloodhound.tokenizers.whitespace(e.Path)},queryTokenizer:Bloodhound.tokenizers.nonword,prefetch:"/WorkflowDefinition/GetVariablePath/"+i});a.initialize(),$(e).typeahead({highlight:!0},{name:"schema_paths"+i,displayKey:"Path",source:a.ttAdapter()}).on("typeahead:closed",function(){o.value($(this).val())})}}},ko.bindingHandlers.activityPopover={init:function(e,t){var n=$(e),i=ko.unwrap(t()),o="function"==typeof i.$type?i.$type():i.$type,a=/Bespoke\.Sph\.Domain\.(.*?),/.exec(o)[1],d=ko.dataFor(n.parent()[0]).wd(),r=n.popover({title:a+" : "+i.Name(),html:!0,content:function(){return $("a.edit-activity").popover("hide"),n.find("a.edit-activity").addClass(i.WebId()),n.find("a.delete-activity").addClass(i.WebId()),n.find("a.start-activity").addClass(i.WebId()),n.find("div.context-menu").html()}});r.on("shown.bs.popover",function(){setTimeout(function(){r.popover("hide")},5e3)}),$(document).on("click","a."+i.WebId(),function(e){e.preventDefault();var t=require(objectbuilders.app),n=$(this);n.hasClass("delete-activity")&&t.showMessage("Are you sure you want to remove this Activity","Remove activity",["Yes","No"]).done(function(e){"Yes"===e&&d.removeActivity(i)()}),n.hasClass("edit-activity")&&d.editActivity(i)(),n.hasClass("start-activity")&&d.setStartActivity(i)()})}},ko.bindingHandlers.comboBoxLookupOptions={init:function(e,t){var n=$(e),i=ko.unwrap(t()),o=i.value,a=i.caption,d=require("services/datacontext"),r=function(t){d.getTuplesAsync({entity:ko.unwrap(i.entity),query:t,field:ko.unwrap(i.valuePath),field2:ko.unwrap(i.displayPath)}).done(function(t){e.options.length=0,a&&e.add(new Option(a,"")),_(t).each(function(t){e.add(new Option(t.Item2,t.Item1))}),n.val(ko.unwrap(o)).on("change",function(){o(n.val())})})};r(ko.unwrap(i.query)),"function"==typeof i.query&&"function"==typeof i.query.subscribe&&i.query.subscribe(function(e){r(ko.unwrap(e))})},update:function(e,t){var n=ko.unwrap(t()),i=n.value;$(e).val(ko.unwrap(i))}};
ko.bindingHandlers.solutiontree={init:function(e,n){var t=n(),a=ko.unwrap(t.items),o=ko.unwrap(t.transforms),i=ko.unwrap(t.wds),r=t.click,d=t.singleClick,c=t.addEntityDefinition,l=t.addForm,s=t.addOperation,u=t.addView,p=t.addBusinessRules,f=[],m=[{id:"EntityDefinition",parent:"#",text:"Entity Definitions",icon:"fa fa-file",data:{TypeName:"#"}},{id:"WorkflowDefinition",parent:"#",text:"Workflow Definitions",icon:"fa fa-code-fork",data:{TypeName:"#"}},{id:"TransformDefinition",parent:"#",text:"Transform Definitions",icon:"fa fa-random",data:{TypeName:"#"}},{id:"Adapter",parent:"#",text:"Adapters",icon:"fa fa-puzzle-piece",data:{TypeName:"#"}},{id:"CustomForm",parent:"#",text:"Custom Forms",icon:"fa fa-file-o",data:{TypeName:"#"}},{id:"CustomDialog",parent:"#",text:"Custom Dialog",icon:"fa fa-file-o",data:{TypeName:"#"}},{id:"CustomScript",parent:"#",text:"Custom Scripts",icon:"fa fa-file-o",data:{TypeName:"#"}},{id:"PartialView",parent:"#",text:"Partial View",icon:"fa fa-file-o",data:{TypeName:"#"}}];_.each(a,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"EntityDefinition",icon:"fa fa-clipboard",data:{TypeName:"EntityDefinition"}}),_.each(e.Forms,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-edit",data:{TypeName:"EntityForm"}})}),_.each(e.Operations,function(n){f.push({id:ko.unwrap(n.WebId),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-gavel",data:{TypeName:"EntityOperation",Name:ko.unwrap(n.Name)}})}),_.each(e.Rdl,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Title),parent:ko.unwrap(e.Id),icon:"fa fa-clipboard",type:"Rdl"})}),_.each(e.Triggers,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-clipboard",data:{TypeName:"Trigger"}})}),_.each(e.Views,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-table",data:{TypeName:"EntityView"}})})}),_.each(o,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"TransformDefinition",icon:"fa fa-clipboard",data:{TypeName:"TransformDefinition"}})}),_.each(i,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"WorkflowDefinition",icon:"fa fa-code-fork",data:{TypeName:"WorkflowDefinition"}})}),$(e).jstree({core:{data:m.concat(f)},plugins:["contextmenu","search"],contextmenu:{items:function(e){return"EntityDefinition"===e.id?{Create:{label:"Add New Entity",action:function(e){c()}}}:"WorkflowDefinition"===e.id?{Create:{label:"Add New Workflow Definition",action:function(e){addWorkflowDefinition()}}}:"TransformDefinition"===e.id?{Create:{label:"Add New Transform Definition",action:function(e){addTransformDefinition()}}}:"Adapter"===e.id?{Create:{label:"Add New Adapter",action:function(e){addAdapter()}}}:"Trigger"===e.id?{Create:{label:"Add New Trigger",action:function(e){addTrigger()}}}:"EntityDefinition"===e.parent?{"Create Business Rules":{label:"Add New Business Rules",action:function(n){p(e.id),console.log(ob)}},"Create Form":{label:"Add New Form",action:function(n){l(e.id)}},"Create Views":{label:"Add New View",action:function(n){u(e.id),console.log(n)}},"Create Operation":{label:"Add New Operation",action:function(n){s(e.id),console.log(n)}}}:void 0}}}),$(e).on("select_node.jstree",d),$(e).delegate("a","dblclick",r)}},ko.bindingHandlers.tree={init:function(e,n){var t=require(objectbuilders.system),a=n(),o=ko.unwrap(a.entity),i=ko.unwrap(a.searchbox),r=a.selected,d={text:o.Name(),state:{opened:!0,selected:!0}},c=function(e){e.children=_(e.data.MemberCollection()).map(function(e){return{text:e.Name(),state:"open",type:e.TypeName(),data:e}}),_(e.children).each(c)},l=function(){d.children=_(o.MemberCollection()).map(function(e){return{text:e.Name(),state:"open",type:e.TypeName(),data:e}}),_(d.children).each(c),$(e).on("select_node.jstree",function(n,t){t.node.data&&(r(t.node.data),r().Name.subscribe(function(n){$(e).jstree(!0).rename_node(t.node,n)}),r().TypeName.subscribe(function(n){$(e).jstree(!0).set_type(t.node,n)}))}).on("create_node.jstree",function(e,n){console.log(n,"node")}).on("rename_node.jstree",function(e,n){var t=n.node.data;t.Name(n.text)}).jstree({core:{animation:0,check_callback:!0,themes:{stripes:!0},data:d},contextmenu:{items:[{label:"Add Child",action:function(){var n=new bespoke.sph.domain.Member({WebId:t.guid(),TypeName:"System.String, mscorlib",Name:"Member_Name"}),a=$(e).jstree("get_selected",!0),i=a[0].data,r={state:"open",type:"System.String, mscorlib",text:"Member_Name",data:n},d=$(e).jstree(!0),c=d.get_selected();return c.length?(c=c[0],c=d.create_node(c,r),c?(d.edit(c),i&&i.MemberCollection?i.MemberCollection.push(n):o.MemberCollection.push(n),!0):!1):!1}},{label:"Remove",action:function(){var n=$(e).jstree(!0),t=n.get_selected(),a=n.get_selected(!0)[0],i=n.get_node($("#"+a.parent)),r=i.data;if(r&&"function"==typeof r.MemberCollection){var d=_(r.MemberCollection()).find(function(e){return e.WebId()===a.data.WebId()});r.MemberCollection.remove(d)}else{var c=_(o.MemberCollection()).find(function(e){return e.WebId()===a.data.WebId()});o.MemberCollection.remove(c)}return t.length?(n.delete_node(t),!0):!1}}]},types:{"System.String, mscorlib":{icon:"glyphicon glyphicon-bold",valid_children:[]},"System.DateTime, mscorlib":{icon:"glyphicon glyphicon-calendar",valid_children:[]},"System.Int32, mscorlib":{icon:"fa fa-sort-numeric-asc",valid_children:[]},"System.Decimal, mscorlib":{icon:"glyphicon glyphicon-usd",valid_children:[]},"System.Boolean, mscorlib":{icon:"glyphicon glyphicon-ok",valid_children:[]},"System.Object, mscorlib":{icon:"fa fa-building-o"},"System.Array, mscorlib":{icon:"glyphicon glyphicon-list"}},plugins:["contextmenu","dnd","types","search"]})};l();var s=!1;$(i).keyup(function(){s&&clearTimeout(s),s=setTimeout(function(){var n=$(i).val();$(e).jstree(!0).search(n)},250)})}},ko.bindingHandlers.help={init:function(e,n){var t=$(e),a=ko.unwrap(n());t.click(function(e){e.preventDefault(),window.open("/docs/#"+a)})}};var substringMatcher=function(e){return function(n,t){var a,o;a=[],o=new RegExp(n,"i"),$.each(e,function(e,n){o.test(n)&&a.push({value:n})}),t(a)}};ko.bindingHandlers.typeaheadUrl={init:function(e,n){var t=ko.unwrap(n()),a=3e5,o=String.format("/list?table={0}&column={1}",t[0],"Route"),i=new Bloodhound({datumTokenizer:Bloodhound.tokenizers.obj.whitespace("name"),queryTokenizer:Bloodhound.tokenizers.whitespace,limit:10,remote:{url:o,tt1:a,filter:function(e){return _(e).map(function(e){return{name:e}})}}});i.initialize(),$(e).typeahead(null,{name:"EntityView_"+$(e).prop("id"),displayKey:"name",source:i.ttAdapter()})}},ko.bindingHandlers.entityTypeaheadPath={init:function(e,n,t){var a=n(),o=require(objectbuilders.datacontext),i=require(objectbuilders.config),r=t(),d=ko.unwrap(n())||window.typeaheadEntity,c=function(n){var t=n.name||n,a=n.id||n,o=ko.toJS(bespoke[i.applicationName+"_"+a.toLowerCase()].domain[t]()),d=$(e),c=$("<div></div>").css({height:"28px"});d.hide().before(c);var l=completely(c[0],{fontSize:"12px",color:"#555;",fontFamily:'"Open Sans", Arial, Helvetica, sans-serif'});l.setText(ko.unwrap(r.value));for(var s in o)"$type"!==s&&"addChildItem"!==s&&"removeChildItem"!==s&&l.options.push(""+s);l.options.sort();var u=o;l.onChange=function(e){if(e.lastIndexOf(".")===e.length-1){l.options=[];var n=e.split(".");u=o,_(n).each(function(e){""!==e&&(u=u[e])}),console.log("currentObject",u);for(var t in u)"$type"!==t&&"addChildItem"!==t&&"removeChildItem"!==t&&l.options.push(""+t);l.options.sort(),l.startFrom=e.lastIndexOf(".")+1}l.repaint()},l.repaint(),$(l.input).attr("autocomplete","off").blur(function(){r.value($(this).val())}).parent().find("input").css({padding:"6px 12px",height:"28px"}),$(e).prop("required")&&$(l.input).prop("required",!0)};d&&o.loadOneAsync("EntityDefinition","Name eq '"+d+"' OR id eq '"+d+"'","Id").done(function(e){c({name:e.Name(),id:e.Id()})}),"function"==typeof a&&"function"==typeof a.subscribe&&a.subscribe(function(n){$(e).typeahead("destroy"),c(n)})}},ko.bindingHandlers.cssTypeahead={init:function(e,n,t){var a=t(),o=["fa","fa-user","fa-user-o"],i=function(e){var n=/([^,]+)$/.exec(e);return n&&n[1]?n[1].trim():""},r=_(o).map(function(e){return{path:e}}),d=new Bloodhound({datumTokenizer:function(e){return e.path.split(/s+/)},queryTokenizer:function(e){return e.split(/\./)},local:r});d.initialize(),$(e).typeahead({minLength:0,highlight:!0,updater:function(){return this.$element.val().replace(/[^,]*$/,"")+item+","},matcher:function(e){var n=i(this.query);return n?~e.toLowerCase().indexOf(n.toLowerCase()):!1}},{name:"css-class",displayKey:"path",source:d.ttAdapter()}).on("typeahead:closed",function(){a.value($(this).val())})}},ko.bindingHandlers.chart={init:function(e,n){var t=ko.unwrap(n()),a=require("services/datacontext"),o=t.Entity(),i=JSON.parse(t.Query()),r=t.Type(),d=new $.Deferred,c=t.Name();return a.searchAsync(o,i).done(function(n){var o=n.aggregations.category.buckets||n.aggregations.category,i=_(o).map(function(e){return{category:e.key_as_string||e.key.toString(),value:e.doc_count}}),l=_(o).map(function(e){return e.key_as_string||e.key.toString()}),s=$(e).kendoChart({theme:"metro",chartArea:{background:""},title:{text:c},legend:{position:"bottom"},seriesDefaults:{labels:{visible:!0,format:"{0}",background:"transparent",template:"#= category #: #= value#"}},series:[{type:r,data:i}],categoryAxis:{categories:l,majorGridLines:{visible:!1}},tooltip:{visible:!0,format:"{0}",template:"#= category #: #= value #"}}).data("kendoChart");d.resolve(!0),a.getScalarAsync("EntityView","Id eq '"+t.EntityViewId()+"'","Name").done(function(e){s.options.title.text=c+" ("+e+")",s.refresh()})}),d.promise()}},ko.bindingHandlers.iconPicker={init:function(e,n){var t=$(e),a=n(),o=$('<a href="#" class="btn btn-link">Pick Icon</a>');t.parent().append(o),o.click(function(e){e.preventDefault(),require(["viewmodels/icon.picker","durandal/app"],function(e,n){n.showDialog(e).done(function(n){"OK"===n&&(a(e.icon()),t.val(e.icon()))})})})}};var bespoke=bespoke||{};bespoke.observableArray=bespoke.observableArray||{},bespoke.getSingletonObservableArray=function(e){return bespoke.observableArray[e]?bespoke.observableArray[e]:(bespoke.observableArray[e]=ko.observableArray(),bespoke.observableArray[e])},ko.bindingHandlers.lookup={init:function(e,n){var t=$(e),a=n(),o=ko.unwrap(a.member);t.click(function(e){e.preventDefault(),e.stopPropagation(),require(["viewmodels/entity.lookup.dialog","durandal/app"],function(e,n){e.options(a),n.showDialog(e).done(function(n){if(n&&"OK"===n){var t=e.selected();a.value(t[o])}})})})}},ko.virtualElements.allowedBindings.lookupText=!0,bespoke.lookupText=function(e,n){var t=n(),a=ko.unwrap(t.entity),o=ko.unwrap(t.displayPath),i=ko.unwrap(t.valuePath),r=ko.unwrap(t.value),d=require("services/datacontext"),c=function(e,n){var t=ko.utils.unwrapObservable(n);(null===t||void 0===t)&&(t="");var a=ko.virtualElements.firstChild(e);!a||3!==a.nodeType||ko.virtualElements.nextSibling(a)?ko.virtualElements.setDomNodeChildren(e,[e.ownerDocument.createTextNode(t)]):a.data=t};d.getScalarAsync(a,i+" eq '"+r+"'",o).done(function(n){c(e,n),console.log(n)})},ko.bindingHandlers.lookupText={init:bespoke.lookupText,update:bespoke.lookupText},ko.bindingHandlers.readonly={init:function(e,n){var t=$(e),a=ko.unwrap(n());a?t.prop("readonly",!0):t.prop("readonly",!1)},update:function(e,n){var t=$(e),a=ko.unwrap(n());a?t.prop("readonly",!0):t.prop("readonly",!1)}};
ko.bindingHandlers.kendoEditor={init:function(e,n){var t=$(e),a=n(),o=!1;setTimeout(function(){var e=t.kendoEditor({change:function(){o||(o=!0,a(this.value()),setTimeout(function(){o=!1},500))}}).data("kendoEditor");e.value(a()),a.subscribe(function(n){o||(o=!0,e.value(n),setTimeout(function(){o=!1},500))})},500)},update2:function(e,n){var t=$(e),a=n(),o=t.data("kendoEditor");t.data("updating")||o.value(a())}},ko.bindingHandlers.kendoDropDownListValue={init:function(e,n){var t=n(),a=ko.utils.unwrapObservable(t),o=$(e).data("kendoDropDownList");o.value(a),o.bind("change",function(){var e=o.value();t(e)})},update:function(e,n){var t=n(),a=ko.utils.unwrapObservable(t);a&&$(e).data("kendoDropDownList").value(a)}},ko.bindingHandlers.source={},ko.bindingHandlers.kendoComboBox={init:function(e,n,t){var a=n(),o=t(),i=ko.utils.unwrapObservable(a),r=$(e).data("kendoComboBox")||$(e).kendoComboBox({dataSource:o.source()}).data("kendoComboBox");r.value(i),o.source.subscribe(function(e){r.dataSource.data(e)}),r.bind("change",function(){var e=r.value();a(e)})},update:function(e,n){var t=n(),a=ko.utils.unwrapObservable(t);a&&$(e).data("kendoComboBox").value(a)}},ko.bindingHandlers.decimal={},ko.bindingHandlers.money={init:function(e,n,t){var a=n(),o=t(),i=function(){return"undefined"==typeof o.decimal?2:parseInt(o.decimal)},r=$(e),l=parseFloat(ko.unwrap(a)||"0"),u=l.toFixed(i()).replace(/./g,function(e,n,t){return!n||"."===e||(t.length-n)%3?e:","+e});return"span"===e.tagName.toLowerCase()?void r.text(u):(r.val(u),void r.on("blur",function(){var e=$(this).val().replace(/,/g,"");console.log(e),a(parseFloat(e))}))},update:function(e,n,t){var a=n(),o=t(),i=function(){return"undefined"==typeof o.decimal?2:parseInt(o.decimal)},r=$(e),l=parseFloat(ko.unwrap(a)||"0"),u=l.toFixed(i()).replace(/./g,function(e,n,t){return!n||"."===e||(t.length-n)%3?e:","+e});r.val(u)}},ko.bindingHandlers.date={init:function(e,n){var t=ko.utils.unwrapObservable(n());if(!t)return $(e).text(""),void $(e).val("");var a=ko.unwrap(t.value),o=ko.unwrap(t.inputFormat)||"YYYY-MM-DD",i=moment(a,o),r=ko.unwrap(t.invalid)||"invalid date",l=ko.unwrap(t.format)||"DD/MM/YYYY";if(t.format||"string"!=typeof ko.unwrap(t)||(a=ko.unwrap(t),i=moment(a)),$(e).on("change",function(){var e=$(this).val();t.value(e)}),!a)return $(e).text(r),void $(e).val(r);if(!i)return $(e).text(""),void $(e).val("");if(1===i.year())return $(e).text(""),void $(e).val("");var u=i.format(l).toString();u.indexOf("NaN")<0&&($(e).text(u),$(e).val(u))},update:function(e,n){var t=ko.utils.unwrapObservable(n());if(!t)return $(e).text(""),void $(e).val("");var a=ko.unwrap(t.value),o=ko.unwrap(t.inputFormat)||"YYYY-MM-DD",i=moment(a,o),r=ko.unwrap(t.invalid)||"invalid date",l=ko.unwrap(t.format)||"DD/MM/YYYY";if(t.format||"string"!=typeof ko.unwrap(t)||(a=ko.unwrap(t),i=moment(a)),$(e).on("change",function(){var e=$(this).val();t.value(e)}),!a)return $(e).text(r),void $(e).val(r);if(!i)return $(e).text(""),void $(e).val("");if(1===i.year())return $(e).text(""),void $(e).val("");var u=i.format(l).toString();u.indexOf("NaN")<0&&($(e).text(u),$(e).val(u))}},ko.bindingHandlers.kendoUpload={init:function(e,n){var t=require(objectbuilders.datacontext),a=require(objectbuilders.logger),o=n(),i=n(),r=[];i&&"object"==typeof i&&(o=i.value,r=i.extensions),$(e).attr("name","files").kendoUpload({async:{saveUrl:"/BinaryStore/Upload",removeUrl:"/BinaryStore/Remove",autoUpload:!0},multiple:!1,error:function(e){a.logError(e,e,this,!0)},select:function(e){0!==r.length&&_(e.files).each(function(n){r.indexOf(n.extension)<0&&(a.error("Only "+r.join(",")+" files can be uploaded"),e.preventDefault())})},success:function(e){a.info("Your file has been "+e.operation);var n=e.response.storeId,i="upload"===e.operation,r="upload"!==e.operation,l=o();i&&(o(n),l&&t.post(JSON.stringify({id:l}),"/BinaryStore/Remove/")),r&&o("")},remove:function(){var e=new $.Deferred,n=JSON.stringify({id:o()});return t.post(n,"/BinaryStore/Remove/").then(function(n){e.resolve(n)}),e.promise()}})}},ko.bindingHandlers.kendoDate={init:function(e,n,t){var a=n(),o=$(e),i=t(),r=ko.unwrap(a),l=moment(r,"DD/MM/YYYY"),u=function(e){console.log(e);var n=this.value();l="string"==typeof n?moment(n,"DD/MM/YYYY"):moment(n),o.data("stop","true"),a(l.format("YYYY-MM-DD")),o.data("stop","false")},s=o.kendoDatePicker({format:"dd/MM/yyyy",change:u}).data("kendoDatePicker");return"boolean"==typeof i.enable&&(i.enable||s.enable(!1)),"function"==typeof i.enable&&"function"==typeof i.enable.subscribe&&i.enable.subscribe(function(e){s.enable(e)}),l?1===l.year()?void s.value(null):(s.value(l.toDate()),void("undefined"==typeof r&&"function"==typeof a&&a(l.format("YYYY-MM-DD")))):void s.value(null)},update:function(e,n,t){var a=$(e),o=t();if("true"!==a.data("stop")){var i=n(),r=ko.utils.unwrapObservable(i),l=moment(r),u=a.data("kendoDatePicker");if(!l)return void u.value(null);if(1===l.year())return void u.value(null);"boolean"==typeof o.enable&&(o.enable||u.enable(!1)),"function"==typeof o.enable&&"function"==typeof o.enable.subscribe&&o.enable.subscribe(function(e){u.enable(e)}),u.value(l.toDate())}}},ko.bindingHandlers.kendoDateTime={init:function(e,n){var t=n(),a=$(e),o=ko.utils.unwrapObservable(t),i=moment(o,"DD/MM/YYYY "),r=function(e){console.log(e);var n=this.value();i="string"==typeof n?moment(n,"DD/MM/YYYY hh:mm"):moment(n),a.data("stop","true"),t(i.format()),a.data("stop","false")},l=a.kendoDateTimePicker({format:"dd/MM/yyyy HH:mm",change:r}).data("kendoDateTimePicker");return i?1===i.year()?void l.value(null):void l.value(i.toDate()):void l.value(null)},update:function(e,n){var t=$(e);if("true"!==t.data("stop")){var a=n(),o=ko.utils.unwrapObservable(a),i=moment(o),r=t.data("kendoDateTimePicker");return i?1===i.year()?void r.value(null):void r.value(i.toDate()):void r.value(null)}}},ko.bindingHandlers.slideVisible={init:function(e,n){var t=n();$(e).toggle(ko.utils.unwrapObservable(t))},update:function(e,n){var t=n();ko.utils.unwrapObservable(t)?$(e).slideDown():$(e).slideUp()}},ko.bindingHandlers.kendoEnable={init:function(e,n){var t=n(),a=ko.utils.unwrapObservable(t);a?$(e).removeClass("k-state-disabled"):$(e).addClass("k-state-disabled")},update:function(e,n){var t=n(),a=ko.utils.unwrapObservable(t);a?($(e).removeClass("k-state-disabled"),$(e).removeAttr("disabled")):($(e).addClass("k-state-disabled"),$(e).attr("disabled","disabled"))}},ko.bindingHandlers.command={init:function(e,n,t){var a=n(),o=$(e),i=t(),r=o.val(),l=require("services/logger");if(i.isvisible){var u="function"==typeof i.isvisible?i.isvisible():i.isvisible;u?o.show():o.hide(),"function"==typeof i.isvisible&&i.isvisible.subscribe(function(e){e?o.show():o.hide()})}var s=$("<i class='fa fa-spin fa-spinner'></i>").hide(),d=$("<i class='fa fa-warning' style='color:red'></i>").hide();o.append(s),o.append(d),o.click(function(e){e.preventDefault(),(!this.form||this.form.checkValidity())&&(s.show(),d.hide(),a().fail(function(e,n,t){return o.button("complete").prop("disabled",!1).val(r).removeClass("btn-disabled"),s.hide(),d.show(),404===e.status?(l.error(t),void l.error(e.statusText)):(e.responseText&&(l.error(e.responseText),console.error(e.responseText)),void(e.responseJSON&&(l.error(JSON.stringify(e.responseJSON)),console.error(e.responseJson))))}).done(function(){o.button("complete").prop("disabled",!1).val(r).removeClass("btn-disabled"),s.hide()}),o.data("loading-text")&&o.button("loading"),o.addClass("btn-disabled").prop("disabled",!0))})}},ko.bindingHandlers.field={init:function(){}},ko.bindingHandlers.unwrapClick={init:function(e,n,t){var a=n(),o=$(e),i=t();o.click(function(e){e.preventDefault();var n=i.property,t=i.accessor,o=i.field,r=i.entity;n?("undefined"==typeof t[n]&&console.log("Can't figure out the accessor.prop"),"object"==typeof t[n]&&(t[n]=ko.observable(t[n])),"function"==typeof t[n]&&a(t[n],o,r)):a(t,o,r)})}},ko.bindingHandlers.fieldImage={init:function(e,n){var t=n(),a=$(e),o="function"==typeof t?t():t;a.attr("src","/image/index/"+o)}},ko.bindingHandlers.stringArrayAutoComplete={init:function(e,n,t){var a=n(),o=t(),i=o.data();$(e).data("kendoAutoComplete")||$(e).kendoAutoComplete({dataSource:i,change:function(){var e=_(this.value().split(",")).filter(function(e){return e});a(e)},filter:"startswith",placeholder:"....",separator:","}).val(a())},update:function(e,n){var t=n();$(e).data("kendoAutoComplete").value(t())}},ko.bindingHandlers.pathAutoComplete={init:function(e,n){var t=n(),a=t.value,o=t.type;o()&&$.get("/App/TriggerPathPickerJson/"+o()).done(function(n){var t=JSON.parse(n),o=_.chain(t).map(function(e){return""===e.parent?e.name:void 0}).filter(function(e){return"undefined"!=typeof e}).value();console.log(o);var i=new kendo.data.DataSource({data:o}),r=$(e).data("kendoAutoComplete")||$(e).kendoAutoComplete({dataSource:t,dataTextField:"path",change:function(){var e=this.value();console.log("selected path ",e)},filter:"startswith",placeholder:"Select path...",separator:""}).data("kendoAutoComplete");$(e).change(function(){a($(this).val()),console.log("new value",a())}).val(a()).on("keydown3",function(e){if(110===e.which||190===e.which){var n=$(this).val()+".";console.log("show the auto complete",n);var a=_.chain(t).filter(function(e){return e.parent===n}).map(function(e){return e.name}).value();console.log(a),i.data(a),r.refresh()}})})}},ko.bindingHandlers.commandWithParameter={init:function(e,n){var t=n(),a=t.command,o=t.commandParameter,i=$(e),r=i.data("complete-text")||i.html();i.click(function(e){e.preventDefault(),a(o).then(function(){i.button("complete"),"BUTTON"===i.get(0).tagName||"A"===i.get(0).tagName?i.html(r):i.val(r)}),i.data("loading-text")&&i.button("loading")})}},ko.bindingHandlers.filter={init:function(e,n,t){var a=n(),o=t(),i=a.path,r=a.tooltip||"Type to filter current page or type and [ENTER] to search the whole view",l=$(e),u=$('<input data-toggle="tooltip" title="'+r+'" type="search" class="search-query input-medium form-control" placeholder="Filter.. ">'),s=$("<a href='/#' title='Carian server'><i class='add-on icon-search'></i><a>"),d=$("<form class='form-search row'> <div class='input-group pull-right' style='width:300px'><span class='input-group-addon'> <span class='glyphicon glyphicon-remove'></span></span> </div> </form>"),c=o.searchPaging;d.find("span.input-group-addon").before(u),c&&d.find("span.glyphicon-remove").after(s),l.before(d),d.submit(function(e){e.preventDefault();var n=u.val().toLowerCase(),t=new $.Deferred;return n&&c&&"undefined"!=typeof c.query&&"function"==typeof c.query.filterAndSearch?c.query.filterAndSearch(n):t.promise()});var f=function(){var e=l.find(i),n=u.val().toLowerCase();e.each(function(){var e=$(this),t=e.text().toLowerCase().trim();t||($("input",e).each(function(e,n){t+=" "+$(n).val()}),t=t.toLowerCase().trim()),t.indexOf(n)>-1?e.show():e.hide()})},p=_.throttle(f,800);u.on("keyup",p).siblings("span.input-group-addon").click(function(){u.val(""),f()}),u.val()&&f(),u.tooltip()}},ko.bindingHandlers.serverPaging={init:function(e,n,t,a){var o=n(),i=o.entity,r=o.query,l=o.list,u=o.map,s=o.pagerHidden||!1,d=$(e),c=require("services/datacontext"),f=$("<div></div>"),p=$('<img src="/Images/spinner-md.gif" alt="loading" class="absolute-center" />'),v=function(){p.show(),d.fadeTo("fast",.33)},m=function(){p.hide(),d.fadeTo("fast",1)},b=function(e){u&&(e=_(e).map(u)),"string"==typeof l&&a[l](e),"function"==typeof l&&l(e)},g=function(e,n){v(),c.loadAsync({entity:i,page:e,size:n,includeTotal:!0},r).then(function(e){b(e.itemCollection),m()})};d.after(f).after(p).fadeTo("slow",.33);var h=new $.Deferred;return c.loadAsync({entity:i,page:1,size:20,includeTotal:!0},r).then(function(e){var n={element:f,count:e.rows,changed:g,hidden:s},t=new bespoke.utils.ServerPager(n);console.log(t),setTimeout(function(){b(e.itemCollection),h.resolve(!0),m()},500)}),h.promise()}},ko.bindingHandlers.searchPaging={init:function(e,n,t,a){var o=n(),i=o.entity,r=o.query,l=o.query||o.initialQuery||{},u=o.list,s=o.map,d=o.pagerHidden||!1,c=o.searchButton,f=$(e),p=require("services/datacontext"),v=require("services/logger"),m=require(objectbuilders.cultures),b=$("<div></div>"),g=$('<img src="/Images/spinner-md.gif" alt="loading" class="absolute-center" />'),h=function(){g.show(),f.fadeTo("fast",.33)},k=function(){g.hide(),f.fadeTo("fast",1)},y=null,w=function(e){d||_(e).each(function(e){e.pager={page:y.page(),size:y.pageSize()}}),s&&(e=_(e).map(s)),"string"==typeof u&&a[u](e),"function"==typeof u&&u(e)},D=function(e,n){h(),p.searchAsync({entity:i,page:e,size:n},l).then(function(e){w(e.itemCollection),k()})},Y=function(e,n,t){l=e;var a=new $.Deferred;return h(),p.searchAsync({entity:i,page:n||1,size:t||20},e).then(function(e){if(y)y.update(e.rows);else{var n={element:b,count:e.rows,changed:D,hidden:d};y=new bespoke.utils.ServerPager(n)}setTimeout(function(){w(e.itemCollection),a.resolve(e),k()},500)}),a.promise()},x=function(e){var n=JSON.parse(ko.toJSON(o.query||o.initialQuery)),t={from:0,size:20,query:{}};n.query=n.query||{},n.query.filtered=n.query.filtered||{},t.query.filtered=n.query.filtered,t.query.filtered.query={query_string:{default_field:"_all",query:e}},t.sort=n.sort,y.destroy(),y=null,Y(t)};return r.search=Y,r.filterAndSearch=x,f.after(b).after(g).fadeTo("slow",.33),c&&$(document).on("click",c,function(e){return e.preventDefault(),$(this).parents("form")[0].checkValidity()?void Y(ko.toJS(r),1,y.pageSize()):void v.error(m.messages.FORM_IS_NOT_VALID)}),Y(ko.toJS(l)),{search:Y,filterAndSearch:x}}};
