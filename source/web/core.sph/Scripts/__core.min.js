...
ko.bindingHandlers.solutiontree={init:function(e,n){var t=n(),o=ko.unwrap(t.items),a=ko.unwrap(t.transforms),i=ko.unwrap(t.wds),r=t.click,d=t.singleClick,l=t.addEntityDefinition,c=t.addForm,s=t.addOperation,p=t.addView,u=t.addBusinessRules,f=[],m=[{id:"EntityDefinition",parent:"#",text:"Entity Definitions",icon:"fa fa-file",data:{TypeName:"#"}},{id:"WorkflowDefinition",parent:"#",text:"Workflow Definitions",icon:"fa fa-code-fork",data:{TypeName:"#"}},{id:"TransformDefinition",parent:"#",text:"Transform Definitions",icon:"fa fa-random",data:{TypeName:"#"}},{id:"Adapter",parent:"#",text:"Adapters",icon:"fa fa-puzzle-piece",data:{TypeName:"#"}},{id:"CustomForm",parent:"#",text:"Custom Forms",icon:"fa fa-file-o",data:{TypeName:"#"}},{id:"CustomDialog",parent:"#",text:"Custom Dialog",icon:"fa fa-file-o",data:{TypeName:"#"}},{id:"CustomScript",parent:"#",text:"Custom Scripts",icon:"fa fa-file-o",data:{TypeName:"#"}},{id:"PartialView",parent:"#",text:"Partial View",icon:"fa fa-file-o",data:{TypeName:"#"}}];_.each(o,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"EntityDefinition",icon:"fa fa-clipboard",data:{TypeName:"EntityDefinition"}}),_.each(e.Forms,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-edit",data:{TypeName:"EntityForm"}})}),_.each(e.Operations,function(n){f.push({id:ko.unwrap(n.WebId),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-gavel",data:{TypeName:"EntityOperation",Name:ko.unwrap(n.Name)}})}),_.each(e.Rdl,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Title),parent:ko.unwrap(e.Id),icon:"fa fa-clipboard",type:"Rdl"})}),_.each(e.Triggers,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-clipboard",data:{TypeName:"Trigger"}})}),_.each(e.Views,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-table",data:{TypeName:"EntityView"}})})}),_.each(a,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"TransformDefinition",icon:"fa fa-clipboard",data:{TypeName:"TransformDefinition"}})}),_.each(i,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"WorkflowDefinition",icon:"fa fa-code-fork",data:{TypeName:"WorkflowDefinition"}})}),$(e).jstree({core:{data:m.concat(f)},plugins:["contextmenu","search"],contextmenu:{items:function(e){return"EntityDefinition"===e.id?{Create:{label:"Add New Entity",action:function(e){l()}}}:"WorkflowDefinition"===e.id?{Create:{label:"Add New Workflow Definition",action:function(e){addWorkflowDefinition()}}}:"TransformDefinition"===e.id?{Create:{label:"Add New Transform Definition",action:function(e){addTransformDefinition()}}}:"Adapter"===e.id?{Create:{label:"Add New Adapter",action:function(e){addAdapter()}}}:"Trigger"===e.id?{Create:{label:"Add New Trigger",action:function(e){addTrigger()}}}:"EntityDefinition"===e.parent?{"Create Business Rules":{label:"Add New Business Rules",action:function(n){u(e.id),console.log(ob)}},"Create Form":{label:"Add New Form",action:function(n){c(e.id)}},"Create Views":{label:"Add New View",action:function(n){p(e.id),console.log(n)}},"Create Operation":{label:"Add New Operation",action:function(n){s(e.id),console.log(n)}}}:void 0}}}),$(e).on("select_node.jstree",d),$(e).delegate("a","dblclick",r)}},ko.bindingHandlers.tree={init:function(e,n){var t=require(objectbuilders.system),o=n(),a=ko.unwrap(o.entity),i=ko.unwrap(o.searchbox),r=o.selected,d={text:a.Name(),state:{opened:!0,selected:!0}},l=function(e){e.children=_(e.data.MemberCollection()).map(function(e){var n=ko.unwrap(e.TypeName)||ko.unwrap(e.$type);return{text:e.Name(),state:"open",type:n,data:e}}),_(e.children).each(l)},c=function(){d.children=_(a.MemberCollection()).map(function(e){return{text:ko.unwrap(e.Name),state:"open",type:ko.unwrap(e.TypeName)||ko.unwrap(e.$type),data:e}}),_(d.children).each(l),$(e).on("select_node.jstree",function(n,t){if(t.node.data){if(r(t.node.data),!ko.unwrap(r))return;if("function"!=typeof r().Name)return;r().Name.subscribe(function(n){$(e).jstree(!0).rename_node(t.node,n)}),"function"==typeof r().TypeName&&r().TypeName.subscribe(function(n){$(e).jstree(!0).set_type(t.node,n)})}}).on("create_node.jstree",function(e,n){console.log(n,"node")}).on("rename_node.jstree",function(e,n){var t=n.node.data;t.Name(n.text)}).jstree({core:{animation:0,check_callback:!0,themes:{stripes:!0},data:d},contextmenu:{items:[{label:"Add Simple Child",action:function(){var n=new bespoke.sph.domain.SimpleMember({WebId:t.guid(),TypeName:"System.String, mscorlib",Name:"Member_Name"}),o=$(e).jstree("get_selected",!0),i=o[0].data,r={state:"open",type:"System.String, mscorlib",text:"Member_Name",data:n},d=$(e).jstree(!0),l=d.get_selected();return l.length?(l=l[0],l=d.create_node(l,r),l?(d.edit(l),i&&i.MemberCollection?i.MemberCollection.push(n):a.MemberCollection.push(n),!0):!1):!1}},{label:"Add Value Object Child",action:function(){var n="Bespoke.Sph.Domain.ValueObjectDefinition, domain.sph",o=new bespoke.sph.domain.ValueObjectMember({WebId:t.guid(),TypeName:n,Name:"Member_Name"}),i=$(e).jstree("get_selected",!0),r=i[0].data,d={state:"open",type:"Bespoke.Sph.Domain.ValueObjectMember, domain.sph",text:"Member_Name",data:o},l=$(e).jstree(!0),c=l.get_selected();return c.length?(c=c[0],c=l.create_node(c,d),c?(l.edit(c),r&&r.MemberCollection?r.MemberCollection.push(o):a.MemberCollection.push(o),!0):!1):!1}},{label:"Add Complex Child",action:function(){var n=new bespoke.sph.domain.ComplexMember({WebId:t.guid(),Name:"Member_Name"}),o=$(e).jstree("get_selected",!0),i=o[0].data,r={state:"open",type:"Bespoke.Sph.Domain.ComplexMember, domain.sph",text:"Member_Name",data:n},d=$(e).jstree(!0),l=d.get_selected();return l.length?(l=l[0],l=d.create_node(l,r),l?(d.edit(l),i&&i.MemberCollection?i.MemberCollection.push(n):a.MemberCollection.push(n),!0):!1):!1}},{label:"Remove",action:function(){var n=$(e).jstree(!0),t=n.get_selected(),o=n.get_selected(!0)[0],i=n.get_node($("#"+o.parent)),r=i.data;if(r&&"function"==typeof r.MemberCollection){var d=_(r.MemberCollection()).find(function(e){return e.WebId()===o.data.WebId()});r.MemberCollection.remove(d)}else{var l=_(a.MemberCollection()).find(function(e){return e.WebId()===o.data.WebId()});a.MemberCollection.remove(l)}return t.length?(n.delete_node(t),!0):!1}}]},types:{"System.String, mscorlib":{icon:"glyphicon glyphicon-bold",valid_children:[]},"System.DateTime, mscorlib":{icon:"glyphicon glyphicon-calendar",valid_children:[]},"System.Int32, mscorlib":{icon:"fa fa-sort-numeric-asc",valid_children:[]},"System.Decimal, mscorlib":{icon:"glyphicon glyphicon-usd",valid_children:[]},"System.Boolean, mscorlib":{icon:"glyphicon glyphicon-ok",valid_children:[]},"Bespoke.Sph.Domain.ValueObjectMember, domain.sph":{icon:"fa fa-object-ungroup"},"Bespoke.Sph.Domain.ComplexMember, domain.sph":{icon:"fa fa-building-o"}},plugins:["contextmenu","dnd","types","search"]})};c();var s=!1;$(i).keyup(function(){s&&clearTimeout(s),s=setTimeout(function(){var n=$(i).val();$(e).jstree(!0).search(n)},250)})}},ko.bindingHandlers.help={init:function(e,n){var t=$(e),o=ko.unwrap(n());t.click(function(e){e.preventDefault(),window.open("/docs/#"+o)})}};var substringMatcher=function(e){return function(n,t){var o,a;o=[],a=new RegExp(n,"i"),$.each(e,function(e,n){a.test(n)&&o.push({value:n})}),t(o)}};ko.bindingHandlers.typeaheadUrl={init:function(e,n){var t=ko.unwrap(n()),o=3e5,a=String.format("/list?table={0}&column={1}",t[0],"Route"),i=new Bloodhound({datumTokenizer:Bloodhound.tokenizers.obj.whitespace("name"),queryTokenizer:Bloodhound.tokenizers.whitespace,limit:10,remote:{url:a,tt1:o,filter:function(e){return _(e).map(function(e){return{name:e}})}}});i.initialize(),$(e).typeahead(null,{name:"EntityView_"+$(e).prop("id"),displayKey:"name",source:i.ttAdapter()})}},ko.bindingHandlers.entityTypeaheadPath={init:function(e,n,t){var o=n(),a=require(objectbuilders.datacontext),i=require(objectbuilders.config),r=t(),d=ko.unwrap(n())||window.typeaheadEntity,l=function(n){var t=n.name||n,o=n.id||n,a=ko.toJS(bespoke[i.applicationName+"_"+o.toLowerCase()].domain[t]()),d=$(e),l=$("<div></div>").css({height:"28px"});d.hide().before(l);var c=completely(l[0],{fontSize:"12px",color:"#555;",fontFamily:'"Open Sans", Arial, Helvetica, sans-serif'});c.setText(ko.unwrap(r.value));for(var s in a)if(a.hasOwnProperty(s)){if("$type"===s)continue;if("addChildItem"===s)continue;if("removeChildItem"===s)continue;c.options.push(""+s)}c.options.sort();var p=a;c.onChange=function(e){if(e.lastIndexOf(".")===e.length-1){c.options=[];var n=e.split(".");p=a,_(n).each(function(e){""!==e&&(p=p[e])}),console.log("currentObject",p);for(var t in p)if(p.hasOwnProperty(t)){if("$type"===t)continue;if("addChildItem"===t)continue;if("removeChildItem"===t)continue;c.options.push(""+t)}c.options.sort(),c.startFrom=e.lastIndexOf(".")+1}c.repaint()},c.repaint(),$(c.input).attr("autocomplete","off").blur(function(){r.value($(this).val())}).parent().find("input").css({padding:"6px 12px",height:"28px"}),$(e).prop("required")&&$(c.input).prop("required",!0)};d&&a.loadOneAsync("EntityDefinition","Name eq '"+d+"' OR id eq '"+d+"'","Id").done(function(e){l({name:e.Name(),id:e.Id()})}),"function"==typeof o&&"function"==typeof o.subscribe&&o.subscribe(function(n){$(e).typeahead("destroy"),l(n)})}},ko.bindingHandlers.cssTypeahead={init:function(e,n,t){var o=t(),a=["fa","fa-user","fa-user-o"],i=function(e){var n=/([^,]+)$/.exec(e);return n&&n[1]?n[1].trim():""},r=_(a).map(function(e){return{path:e}}),d=new Bloodhound({datumTokenizer:function(e){return e.path.split(/s+/)},queryTokenizer:function(e){return e.split(/\./)},local:r});d.initialize(),$(e).typeahead({minLength:0,highlight:!0,updater:function(){return this.$element.val().replace(/[^,]*$/,"")+item+","},matcher:function(e){var n=i(this.query);return n?~e.toLowerCase().indexOf(n.toLowerCase()):!1}},{name:"css-class",displayKey:"path",source:d.ttAdapter()}).on("typeahead:closed",function(){o.value($(this).val())})}},ko.bindingHandlers.chart={init:function(e,n){var t=ko.unwrap(n()),o=require("services/datacontext"),a=t.Entity(),i=JSON.parse(t.Query()),r=t.Type(),d=new $.Deferred,l=t.Name();return o.searchAsync(a,i).done(function(n){var a=n.aggregations.category.buckets||n.aggregations.category,i=_(a).map(function(e){return{category:e.key_as_string||e.key.toString(),value:e.doc_count}}),c=_(a).map(function(e){return e.key_as_string||e.key.toString()}),s=$(e).kendoChart({theme:"metro",chartArea:{background:""},title:{text:l},legend:{position:"bottom"},seriesDefaults:{labels:{visible:!0,format:"{0}",background:"transparent",template:"#= category #: #= value#"}},series:[{type:r,data:i}],categoryAxis:{categories:c,majorGridLines:{visible:!1}},tooltip:{visible:!0,format:"{0}",template:"#= category #: #= value #"}}).data("kendoChart");d.resolve(!0),o.getScalarAsync("EntityView","Id eq '"+t.EntityViewId()+"'","Name").done(function(e){s.options.title.text=l+" ("+e+")",s.refresh()})}),d.promise()}},ko.bindingHandlers.iconPicker={init:function(e,n){var t=$(e),o=n(),a=$('<a href="#" class="btn btn-link">Pick Icon</a>');t.parent().append(a),a.click(function(e){e.preventDefault(),require(["viewmodels/icon.picker","durandal/app"],function(e,n){n.showDialog(e).done(function(n){"OK"===n&&(o(e.icon()),t.val(e.icon()))})})})}};var bespoke=bespoke||{};bespoke.observableArray=bespoke.observableArray||{},bespoke.getSingletonObservableArray=function(e){return bespoke.observableArray[e]?bespoke.observableArray[e]:(bespoke.observableArray[e]=ko.observableArray(),bespoke.observableArray[e])},ko.bindingHandlers.lookup={init:function(e,n){var t=$(e),o=n(),a=ko.unwrap(o.member);t.click(function(e){e.preventDefault(),e.stopPropagation(),require(["viewmodels/entity.lookup.dialog","durandal/app"],function(e,n){e.options(o),n.showDialog(e).done(function(n){if(n&&"OK"===n){var t=e.selected();o.value(t[a])}})})})}},ko.virtualElements.allowedBindings.lookupText=!0,bespoke.lookupText=function(e,n){var t=n(),o=ko.unwrap(t.entity),a=ko.unwrap(t.displayPath),i=ko.unwrap(t.valuePath),r=ko.unwrap(t.value),d=require("services/datacontext"),l=function(e,n){var t=ko.utils.unwrapObservable(n);(null===t||void 0===t)&&(t="");var o=ko.virtualElements.firstChild(e);!o||3!==o.nodeType||ko.virtualElements.nextSibling(o)?ko.virtualElements.setDomNodeChildren(e,[e.ownerDocument.createTextNode(t)]):o.data=t};d.getScalarAsync(o,i+" eq '"+r+"'",a).done(function(n){l(e,n),console.log(n)})},ko.bindingHandlers.lookupText={init:bespoke.lookupText,update:bespoke.lookupText},ko.bindingHandlers.readonly={init:function(e,n){var t=$(e),o=ko.unwrap(n());o?t.prop("readonly",!0):t.prop("readonly",!1)},update:function(e,n){var t=$(e),o=ko.unwrap(n());o?t.prop("readonly",!0):t.prop("readonly",!1)}};
