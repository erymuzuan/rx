...
var bespoke=bespoke||{};bespoke.utils={},bespoke.utils.ServerPager=function(e){e=e||{};var a=e.element,t=e.count||0,r=e.changed||function(){console.log("no change event")},n=this,i=_.range(t),o=new kendo.data.DataSource({data:i,pageSize:20});if(e.hidden)return n;var u=a.kendoPager({dataSource:o,messages:{display:"{0} - {1} of {2} rekod",empty:"Tiada rekod",page:"Muka",of:"dari {0}",itemsPerPage:"rekod setiap mukasurat",first:"Pergi mukasurat pertama",previous:"Pergi ke mukasurat belakang",next:"Sergi mukasurat depan",last:"Pergi mukasurat terakhir",refresh:"Muat"},pageSizes:[10,20,50]}).data("kendoPager");u.page(1),u.bind("change",function(){r&&r(u.page(),u.pageSize())}),n.update=function(e){i=[];for(var a=0;e>a;a++)i[a]=a;setTimeout(function(){o.data(i)},500)},n.destroy=function(){u.destroy(),a.empty()},n.pageSize=function(e){return e&&u.pageSize(e),u.pageSize()},n.page=function(e){return e&&u.page(e),u.page()};var s=$(a).find("select").data("kendoDropDownList");return s.bind("change",function(){try{r(1,parseInt(this.value()))}catch(e){}}),n};
