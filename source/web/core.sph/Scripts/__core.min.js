...
ko.bindingHandlers.tree={init:function(e,n){var t=require(objectbuilders.system),o=n(),a=ko.unwrap(o.entity),i=ko.unwrap(o.searchbox),r=o.selected,l={text:a.Name(),state:{opened:!0,selected:!0}},u=function(e){var n=ko.unwrap(e.TypeName)||ko.unwrap(e.$type);return n.indexOf(",")<0&&(n=ko.unwrap(e.$type)),n},s=null,c=null,p=function(e){e.children=_(e.data.MemberCollection()).map(function(e){var n=u(e);return{text:e.Name(),state:"open",type:n,data:e}}),_(e.children).each(p)},d=function(n,t){ko.isObservable(t.childOfValueMember)||(t.childOfValueMember=ko.observable(!0));var o=$(e).jstree(!0),a=_(n.parents).map(function(e){return o.get_node(e)}),i=_(a).find(function(e){return"Bespoke.Sph.Domain.ValueObjectMember, domain.sph"===e.type});t.childOfValueMember(i||!1)},m=function(){l.children=_(a.MemberCollection()).map(function(e){return{text:ko.unwrap(e.Name),state:"open",type:u(e),data:e}}),_(l.children).each(p),$(e).on("select_node.jstree",function(n,t){if("function"==typeof r){s&&(s.dispose(),s=null),c&&(c.dispose(),c=null);var o=t.node.data;if(o){if("default"===t.node.type)return;ko.isObservable(o.childOfValueMember)||(o.childOfValueMember=ko.observable(!0)),ko.isObservable(o.allowFilter)||(o.allowFilter=ko.observable(!0));var a=$(e).jstree(!0),i=_(t.node.parents).map(function(e){return a.get_node(e)}),l=_(i).find(function(e){return"Bespoke.Sph.Domain.ValueObjectMember, domain.sph"===e.type});if(o.childOfValueMember(l||!1),!l){var u=_(i).find(function(e){var n=e.data;return"Bespoke.Sph.Domain.ComplexMember, domain.sph"===e.type&&ko.unwrap(n.AllowMultiple)});u&&o.allowFilter(!1)}o.childOfValueMember()||a.edit(t.node),r(o),s=r().Name.subscribe(function(n){$(e).jstree(!0).rename_node(t.node,n),console.log("rename "+n)}),"function"==typeof r().TypeName&&(c=r().TypeName.subscribe(function(n){$(e).jstree(!0).set_type(t.node,n)}))}}}).on("create_node.jstree",function(e,n){console.log(n,"node")}).on("move_node.jstree",function(n,t){var o=$(e).jstree(!0),i=t.node.data,r=o.get_node(t.old_parent),l=r.data.MemberCollection||a.MemberCollection,u=o.get_node(t.parent),s=u.data.MemberCollection||a.MemberCollection;l.remove(function(e){return ko.unwrap(i.WebId)===ko.unwrap(e.WebId)}),s.splice(t.position,0,i)}).on("rename_node.jstree",function(e,n){var t=n.node.data;t.Name(n.text)}).jstree({core:{animation:0,check_callback:function(n,t,o,a,i){if("move_node"===n){var r=t.data,l=$(e).jstree(!0),u=l.get_node(o);return r&&u?(ko.isObservable(r.childOfValueMember)||d(t,r),ko.unwrap(r.childOfValueMember)?!1:"Bespoke.Sph.Domain.ValueObjectMember, domain.sph"===u.type?!1:!0):!1}return!0},themes:{stripes:!0},data:l},dnd:{is_draggable:function(e){var n=e.data;return n&&ko.unwrap(n.childOfValueMember)?!1:!0}},contextmenu:{items:function(n){var o=$(e).jstree(!0),i=_(n.parents).map(function(e){return o.get_node(e)}),r=_(i).find(function(e){return"Bespoke.Sph.Domain.ValueObjectMember, domain.sph"===e.type}),l=o.get_selected();if(r)return[];var u={label:"Add Simple Child",action:function(){var n=new bespoke.sph.domain.SimpleMember({WebId:t.guid(),TypeName:"System.String, mscorlib",Name:"Member_Name"}),i=$(e).jstree("get_selected",!0),r=i[0].data,u={state:"open",type:"System.String, mscorlib",text:"Member_Name",data:n};return l.length?(l=l[0],l=o.create_node(l,u),l?(o.edit(l),r&&r.MemberCollection?r.MemberCollection.push(n):a.MemberCollection.push(n),!0):!1):!1}},s={label:"Add Value Object Child",action:function(){var n="Bespoke.Sph.Domain.ValueObjectDefinition, domain.sph",i=new bespoke.sph.domain.ValueObjectMember({WebId:t.guid(),TypeName:n,Name:"Member_Name"}),r=$(e).jstree("get_selected",!0),u=r[0].data,s={state:"open",type:"Bespoke.Sph.Domain.ValueObjectMember, domain.sph",text:"Member_Name",data:i};return l.length?(l=l[0],l=o.create_node(l,s),l?(o.edit(l),u&&u.MemberCollection?u.MemberCollection.push(i):a.MemberCollection.push(i),!0):!1):!1}},c={label:"Add Complex Child",action:function(){var n=new bespoke.sph.domain.ComplexMember({WebId:t.guid(),Name:"Member_Name"}),i=$(e).jstree("get_selected",!0),r=i[0].data,u={state:"open",type:"Bespoke.Sph.Domain.ComplexMember, domain.sph",text:"Member_Name",data:n};return l.length?(l=l[0],l=o.create_node(l,u),l?(o.edit(l),r&&r.MemberCollection?r.MemberCollection.push(n):a.MemberCollection.push(n),!0):!1):!1}},p={label:"Remove",action:function(){var e=o.get_selected(!0)[0],n=o.get_node($("#"+e.parent)),t=n.data;if(t&&"function"==typeof t.MemberCollection){var i=_(t.MemberCollection()).find(function(n){return n.WebId()===e.data.WebId()});t.MemberCollection.remove(i)}else{var r=_(a.MemberCollection()).find(function(n){return n.WebId()===e.data.WebId()});a.MemberCollection.remove(r)}return l.length?(o.delete_node(l),!0):!1}},d=[];return("default"===n.type||"Bespoke.Sph.Domain.ComplexMember, domain.sph"===n.type)&&(d.push(u),d.push(s),d.push(c)),console.log(n),"default"!==n.type&&d.push(p),d}},types:{"default":{icon:"fa fa-clipboard"},"System.String, mscorlib":{icon:"glyphicon glyphicon-bold",valid_children:[]},"System.DateTime, mscorlib":{icon:"glyphicon glyphicon-calendar",valid_children:[]},"System.Int32, mscorlib":{icon:"fa fa-sort-numeric-asc",valid_children:[]},"System.Decimal, mscorlib":{icon:"glyphicon glyphicon-usd",valid_children:[]},"System.Boolean, mscorlib":{icon:"glyphicon glyphicon-ok",valid_children:[]},"Bespoke.Sph.Domain.ValueObjectMember, domain.sph":{icon:"fa fa-object-ungroup"},"Bespoke.Sph.Domain.ComplexMember, domain.sph":{icon:"fa fa-object-group"}},plugins:["contextmenu","dnd","types","search"]})};m();var b=!1;$(i).keyup(function(){b&&clearTimeout(b),b=setTimeout(function(){var n=$(i).val();$(e).jstree(!0).search(n)},250)})}},ko.bindingHandlers.help={init:function(e,n){var t=$(e),o=ko.unwrap(n());t.click(function(e){e.preventDefault(),window.open("/docs/#"+o)})}};var substringMatcher=function(e){return function(n,t){var o,a;o=[],a=new RegExp(n,"i"),$.each(e,function(e,n){a.test(n)&&o.push({value:n})}),t(o)}};ko.bindingHandlers.typeaheadUrl={init:function(e,n){var t=ko.unwrap(n()),o=3e5,a=String.format("/list?table={0}&column={1}",t[0],"Route"),i=new Bloodhound({datumTokenizer:Bloodhound.tokenizers.obj.whitespace("name"),queryTokenizer:Bloodhound.tokenizers.whitespace,limit:10,remote:{url:a,tt1:o,filter:function(e){return _(e).map(function(e){return{name:e}})}}});i.initialize(),$(e).typeahead(null,{name:"EntityView_"+$(e).prop("id"),displayKey:"name",source:i.ttAdapter()})}},ko.bindingHandlers.entityTypeaheadPath={init:function(e,n,t){var o=n(),a=require(objectbuilders.datacontext),i=require(objectbuilders.config),r=t(),l=ko.unwrap(n())||window.typeaheadEntity,u=function(n){String.prototype.toCamelCase=function(){return this.replace(/^([A-Z])|\s(\w)/g,function(e,n,t,o){return t?t.toUpperCase():n.toLowerCase()})};var t=n.name||n,o=(n.id||n,t.toCamelCase()),a=ko.toJS(bespoke[i.applicationName+"_"+o].domain[t]()),l=$(e),u=$("<div></div>").css({height:"28px"});l.hide().before(u);var s=completely(u[0],{fontSize:"12px",color:"#555;",fontFamily:'"Open Sans", Arial, Helvetica, sans-serif'});s.setText(ko.unwrap(r.value));for(var c in a)if(a.hasOwnProperty(c)){if("$type"===c)continue;if("addChildItem"===c)continue;if("removeChildItem"===c)continue;if("Empty"===c)continue;if("WebId"===c)continue;s.options.push(""+c)}s.options.sort();var p=a;s.onChange=function(e){if(e.lastIndexOf(".")===e.length-1){s.options=[];var n=e.split(".");p=a,_(n).each(function(e){""!==e&&(p=p[e])}),console.log("currentObject",p);for(var t in p)if(p.hasOwnProperty(t)){if("$type"===t)continue;if("addChildItem"===t)continue;if("removeChildItem"===t)continue;if("Empty"===t)continue;if("WebId"===t)continue;s.options.push(""+t)}s.options.sort(),s.startFrom=e.lastIndexOf(".")+1}s.repaint()},s.repaint(),$(s.input).attr("autocomplete","off").blur(function(){r.value($(this).val())}).parent().find("input").css({padding:"6px 12px",height:"28px"}),$(e).prop("required")&&$(s.input).prop("required",!0),s.hideDropDown()};l&&a.loadOneAsync("EntityDefinition","Name eq '"+l+"' OR id eq '"+l+"'","Id").done(function(e){u({name:e.Name(),id:e.Id()})}),"function"==typeof o&&"function"==typeof o.subscribe&&o.subscribe(function(n){$(e).typeahead("destroy"),u(n)})}},ko.bindingHandlers.cssTypeahead={init:function(e,n,t){var o=t(),a=["fa","fa-user","fa-user-o"],i=function(e){var n=/([^,]+)$/.exec(e);return n&&n[1]?n[1].trim():""},r=_(a).map(function(e){return{path:e}}),l=new Bloodhound({datumTokenizer:function(e){return e.path.split(/s+/)},queryTokenizer:function(e){return e.split(/\./)},local:r});l.initialize(),$(e).typeahead({minLength:0,highlight:!0,updater:function(){return this.$element.val().replace(/[^,]*$/,"")+item+","},matcher:function(e){var n=i(this.query);return n?~e.toLowerCase().indexOf(n.toLowerCase()):!1}},{name:"css-class",displayKey:"path",source:l.ttAdapter()}).on("typeahead:closed",function(){o.value($(this).val())})}},ko.bindingHandlers.chart={init:function(e,n){var t=ko.unwrap(n()),o=require("services/datacontext"),a=t.Entity(),i=JSON.parse(t.Query()),r=t.Type(),l=new $.Deferred,u=t.Name();return o.searchAsync(a,i).done(function(n){var a=n.aggregations.category.buckets||n.aggregations.category,i=_(a).map(function(e){return{category:e.key_as_string||e.key.toString(),value:e.doc_count}}),s=_(a).map(function(e){return e.key_as_string||e.key.toString()}),c=$(e).kendoChart({theme:"metro",chartArea:{background:""},title:{text:u},legend:{position:"bottom"},seriesDefaults:{labels:{visible:!0,format:"{0}",background:"transparent",template:"#= category #: #= value#"}},series:[{type:r,data:i}],categoryAxis:{categories:s,majorGridLines:{visible:!1}},tooltip:{visible:!0,format:"{0}",template:"#= category #: #= value #"}}).data("kendoChart");l.resolve(!0),o.getScalarAsync("EntityView","Id eq '"+t.EntityViewId()+"'","Name").done(function(e){c.options.title.text=u+" ("+e+")",c.refresh()})}),l.promise()}},ko.bindingHandlers.iconPicker={init:function(e,n){var t=$(e),o=n(),a=$('<a href="#" class="btn btn-link">Pick Icon</a>');t.parent().append(a),a.click(function(e){e.preventDefault(),require(["viewmodels/icon.picker","durandal/app"],function(e,n){n.showDialog(e).done(function(n){"OK"===n&&(o(e.icon()),t.val(e.icon()))})})})}};var bespoke=bespoke||{};bespoke.observableArray=bespoke.observableArray||{},bespoke.getSingletonObservableArray=function(e){return bespoke.observableArray[e]?bespoke.observableArray[e]:(bespoke.observableArray[e]=ko.observableArray(),bespoke.observableArray[e])},ko.bindingHandlers.lookup={init:function(e,n){var t=$(e),o=n(),a=ko.unwrap(o.member);t.click(function(e){e.preventDefault(),e.stopPropagation(),require(["viewmodels/entity.lookup.dialog","durandal/app"],function(e,n){e.options(o),n.showDialog(e).done(function(n){if(n&&"OK"===n){var t=e.selected();o.value(t[a])}})})})}},ko.virtualElements.allowedBindings.lookupText=!0,bespoke.lookupText=function(e,n){var t=n(),o=ko.unwrap(t.entity),a=ko.unwrap(t.displayPath),i=ko.unwrap(t.valuePath),r=ko.unwrap(t.value),l=require("services/datacontext"),u=function(e,n){var t=ko.utils.unwrapObservable(n);(null===t||void 0===t)&&(t="");var o=ko.virtualElements.firstChild(e);!o||3!==o.nodeType||ko.virtualElements.nextSibling(o)?ko.virtualElements.setDomNodeChildren(e,[e.ownerDocument.createTextNode(t)]):o.data=t};l.getScalarAsync(o,i+" eq '"+r+"'",a).done(function(n){u(e,n),console.log(n)})},ko.bindingHandlers.lookupText={init:bespoke.lookupText,update:bespoke.lookupText},ko.bindingHandlers.readonly={init:function(e,n){var t=$(e),o=ko.unwrap(n());o?t.prop("readonly",!0):t.prop("readonly",!1)},update:function(e,n){var t=$(e),o=ko.unwrap(n());o?t.prop("readonly",!0):t.prop("readonly",!1)}};
