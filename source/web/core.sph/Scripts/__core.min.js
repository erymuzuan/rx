...
ko.bindingHandlers.solutiontree={init:function(e,n){var t=n(),i=ko.unwrap(t.items),a=ko.unwrap(t.transforms),o=ko.unwrap(t.wds),r=t.click,d=t.singleClick,c=t.addEntityDefinition,l=t.addForm,s=t.addOperation,u=t.addView,p=t.addBusinessRules,f=[],m=[{id:"EntityDefinition",parent:"#",text:"Entity Definitions",icon:"fa fa-file",data:{TypeName:"#"}},{id:"WorkflowDefinition",parent:"#",text:"Workflow Definitions",icon:"fa fa-file",data:{TypeName:"#"}},{id:"TransformDefinition",parent:"#",text:"Transform Definitions",icon:"fa fa-file",data:{TypeName:"#"}},{id:"Adapter",parent:"#",text:"Adapters",icon:"fa fa-file",data:{TypeName:"#"}}];_.each(i,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"EntityDefinition",icon:"fa fa-clipboard",data:{TypeName:"EntityDefinition"}}),_.each(e.Forms,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-edit",data:{TypeName:"EntityForm"}})}),_.each(e.Operations,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-gavel",data:{TypeName:"EntityOperation",Name:ko.unwrap(n.Name)}})}),_.each(e.Rdl,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-clipboard",type:"Rdl"})}),_.each(e.Triggers,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-clipboard",data:{TypeName:"Trigger"}})}),_.each(e.Views,function(n){f.push({id:ko.unwrap(n.Id),text:ko.unwrap(n.Name),parent:ko.unwrap(e.Id),icon:"fa fa-table",data:{TypeName:"EntityView"}})})}),_.each(a,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"TransformDefinition",icon:"fa fa-clipboard",data:{TypeName:"TransformDefinition"}})}),_.each(o,function(e){f.push({id:ko.unwrap(e.Id),text:ko.unwrap(e.Name),parent:"WorkflowDefinition",icon:"fa fa-code-form",data:{TypeName:"WorkflowDefinition"}})}),$(e).jstree({core:{data:m.concat(f)},plugins:["contextmenu","search"],contextmenu:{items:function(e){return"EntityDefinition"===e.id?{Create:{label:"Add New Entity",action:function(){c()}}}:"WorkflowDefinition"===e.id?{Create:{label:"Add New Workflow Definition",action:function(){addWorkflowDefinition()}}}:"TransformDefinition"===e.id?{Create:{label:"Add New Transform Definition",action:function(){addTransformDefinition()}}}:"Adapter"===e.id?{Create:{label:"Add New Adapter",action:function(){addAdapter()}}}:"Trigger"===e.id?{Create:{label:"Add New Trigger",action:function(){addTrigger()}}}:"EntityDefinition"===e.parent?{"Create Business Rules":{label:"Add New Business Rules",action:function(){p(e.id)}},"Create Form":{label:"Add New Form",action:function(){l(e.id)}},"Create Views":{label:"Add New View",action:function(){u(e.id)}},"Create Operation":{label:"Add New Operation",action:function(){s(e.id)}}}:void 0}}}),$(e).on("select_node.jstree",d),$(e).delegate("a","dblclick",r)}},ko.bindingHandlers.tree={init:function(e,n){var t=require(objectbuilders.system),i=n(),a=ko.unwrap(i.entity),o=ko.unwrap(i.searchbox),r=i.selected,d={text:a.Name(),state:{opened:!0,selected:!0}},c=function(e){e.children=_(e.data.MemberCollection()).map(function(e){return{text:e.Name(),state:"open",type:e.TypeName(),data:e}}),_(e.children).each(c)},l=function(){d.children=_(a.MemberCollection()).map(function(e){return{text:e.Name(),state:"open",type:e.TypeName(),data:e}}),_(d.children).each(c),$(e).on("select_node.jstree",function(n,t){t.node.data&&(r(t.node.data),r().Name.subscribe(function(n){$(e).jstree(!0).rename_node(t.node,n)}),r().TypeName.subscribe(function(n){$(e).jstree(!0).set_type(t.node,n)}))}).on("create_node.jstree",function(e,n){console.log(n,"node")}).on("rename_node.jstree",function(e,n){var t=n.node.data;t.Name(n.text)}).jstree({core:{animation:0,check_callback:!0,themes:{stripes:!0},data:d},contextmenu:{items:[{label:"Add Child",action:function(){var n=new bespoke.sph.domain.Member({WebId:t.guid(),TypeName:"System.String, mscorlib",Name:"Member_Name"}),i=$(e).jstree("get_selected",!0),o=i[0].data,r={state:"open",type:"System.String, mscorlib",text:"Member_Name",data:n},d=$(e).jstree(!0),c=d.get_selected();return c.length?(c=c[0],c=d.create_node(c,r),c?(d.edit(c),o&&o.MemberCollection?o.MemberCollection.push(n):a.MemberCollection.push(n),!0):!1):!1}},{label:"Remove",action:function(){var n=$(e).jstree(!0),t=n.get_selected(),i=n.get_selected(!0)[0],o=n.get_node($("#"+i.parent)),r=o.data;if(r&&"function"==typeof r.MemberCollection){var d=_(r.MemberCollection()).find(function(e){return e.WebId()===i.data.WebId()});r.MemberCollection.remove(d)}else{var c=_(a.MemberCollection()).find(function(e){return e.WebId()===i.data.WebId()});a.MemberCollection.remove(c)}return t.length?(n.delete_node(t),!0):!1}}]},types:{"System.String, mscorlib":{icon:"glyphicon glyphicon-bold",valid_children:[]},"System.DateTime, mscorlib":{icon:"glyphicon glyphicon-calendar",valid_children:[]},"System.Int32, mscorlib":{icon:"fa fa-sort-numeric-asc",valid_children:[]},"System.Decimal, mscorlib":{icon:"glyphicon glyphicon-usd",valid_children:[]},"System.Boolean, mscorlib":{icon:"glyphicon glyphicon-ok",valid_children:[]},"System.Object, mscorlib":{icon:"fa fa-building-o"},"System.Array, mscorlib":{icon:"glyphicon glyphicon-list"}},plugins:["contextmenu","dnd","types","search"]})};l();var s=!1;$(o).keyup(function(){s&&clearTimeout(s),s=setTimeout(function(){var n=$(o).val();$(e).jstree(!0).search(n)},250)})}},ko.bindingHandlers.help={init:function(e,n){var t=$(e),i=ko.unwrap(n());t.click(function(e){e.preventDefault(),window.open("/docs/#"+i)})}};var substringMatcher=function(e){return function(n,t){var i,a;i=[],a=new RegExp(n,"i"),$.each(e,function(e,n){a.test(n)&&i.push({value:n})}),t(i)}};ko.bindingHandlers.typeaheadUrl={init:function(e,n){var t=ko.unwrap(n()),i=3e5,a=String.format("/list?table={0}&column={1}",t[0],"Route"),o=new Bloodhound({datumTokenizer:Bloodhound.tokenizers.obj.whitespace("name"),queryTokenizer:Bloodhound.tokenizers.whitespace,limit:10,remote:{url:a,tt1:i,filter:function(e){return _(e).map(function(e){return{name:e}})}}});o.initialize(),$(e).typeahead(null,{name:"EntityView_"+$(e).prop("id"),displayKey:"name",source:o.ttAdapter()})}},ko.bindingHandlers.entityTypeaheadPath={init:function(e,n,t){var i=n(),a=require(objectbuilders.datacontext),o=require(objectbuilders.config),r=t(),d=ko.unwrap(n())||window.typeaheadEntity,c=function(n){var t=n.name||n,i=n.id||n,a=ko.toJS(bespoke[o.applicationName+"_"+i.toLowerCase()].domain[t]()),d=$(e),c=$("<div></div>").css({height:"28px"});d.hide().before(c);var l=completely(c[0],{fontSize:"12px",color:"#555;",fontFamily:'"Open Sans", Arial, Helvetica, sans-serif'});l.setText(ko.unwrap(r.value));for(var s in a)"$type"!==s&&"addChildItem"!==s&&"removeChildItem"!==s&&l.options.push(""+s);l.options.sort();var u=a;l.onChange=function(e){if(e.lastIndexOf(".")===e.length-1){l.options=[];var n=e.split(".");u=a,_(n).each(function(e){""!==e&&(u=u[e])}),console.log("currentObject",u);for(var t in u)"$type"!==t&&"addChildItem"!==t&&"removeChildItem"!==t&&l.options.push(""+t);l.options.sort(),l.startFrom=e.lastIndexOf(".")+1}l.repaint()},l.repaint(),$(l.input).attr("autocomplete","off").blur(function(){r.value($(this).val())}).parent().find("input").css({padding:"6px 12px",height:"28px"}),$(e).prop("required")&&$(l.input).prop("required",!0)};d&&a.loadOneAsync("EntityDefinition","Name eq '"+d+"' OR id eq '"+d+"'","Id").done(function(e){c({name:e.Name(),id:e.Id()})}),"function"==typeof i&&"function"==typeof i.subscribe&&i.subscribe(function(n){$(e).typeahead("destroy"),c(n)})}},ko.bindingHandlers.cssTypeahead={init:function(e,n,t){var i=t(),a=["fa","fa-user","fa-user-o"],o=function(e){var n=/([^,]+)$/.exec(e);return n&&n[1]?n[1].trim():""},r=_(a).map(function(e){return{path:e}}),d=new Bloodhound({datumTokenizer:function(e){return e.path.split(/s+/)},queryTokenizer:function(e){return e.split(/\./)},local:r});d.initialize(),$(e).typeahead({minLength:0,highlight:!0,updater:function(){return this.$element.val().replace(/[^,]*$/,"")+item+","},matcher:function(e){var n=o(this.query);return n?~e.toLowerCase().indexOf(n.toLowerCase()):!1}},{name:"css-class",displayKey:"path",source:d.ttAdapter()}).on("typeahead:closed",function(){i.value($(this).val())})}},ko.bindingHandlers.chart={init:function(e,n){var t=ko.unwrap(n()),i=require("services/datacontext"),a=t.Entity(),o=JSON.parse(t.Query()),r=t.Type(),d=new $.Deferred,c=t.Name();return i.searchAsync(a,o).done(function(n){var a=n.aggregations.category.buckets||n.aggregations.category,o=_(a).map(function(e){return{category:e.key_as_string||e.key.toString(),value:e.doc_count}}),l=_(a).map(function(e){return e.key_as_string||e.key.toString()}),s=$(e).kendoChart({theme:"metro",chartArea:{background:""},title:{text:c},legend:{position:"bottom"},seriesDefaults:{labels:{visible:!0,format:"{0}",background:"transparent",template:"#= category #: #= value#"}},series:[{type:r,data:o}],categoryAxis:{categories:l,majorGridLines:{visible:!1}},tooltip:{visible:!0,format:"{0}",template:"#= category #: #= value #"}}).data("kendoChart");d.resolve(!0),i.getScalarAsync("EntityView","Id eq '"+t.EntityViewId()+"'","Name").done(function(e){s.options.title.text=c+" ("+e+")",s.refresh()})}),d.promise()}},ko.bindingHandlers.iconPicker={init:function(e,n){var t=$(e),i=n(),a=$('<a href="#" class="btn btn-link">Pick Icon</a>');t.parent().append(a),a.click(function(e){e.preventDefault(),require(["viewmodels/icon.picker","durandal/app"],function(e,n){n.showDialog(e).done(function(n){"OK"===n&&(i(e.icon()),t.val(e.icon()))})})})}};var bespoke=bespoke||{};bespoke.observableArray=bespoke.observableArray||{},bespoke.getSingletonObservableArray=function(e){return bespoke.observableArray[e]?bespoke.observableArray[e]:(bespoke.observableArray[e]=ko.observableArray(),bespoke.observableArray[e])},ko.bindingHandlers.lookup={init:function(e,n){var t=$(e),i=n(),a=ko.unwrap(i.member);t.click(function(e){e.preventDefault(),e.stopPropagation(),require(["viewmodels/entity.lookup.dialog","durandal/app"],function(e,n){e.options(i),n.showDialog(e).done(function(n){if(n&&"OK"===n){var t=e.selected();i.value(t[a])}})})})}},ko.virtualElements.allowedBindings.lookupText=!0,bespoke.lookupText=function(e,n){var t=n(),i=ko.unwrap(t.entity),a=ko.unwrap(t.displayPath),o=ko.unwrap(t.valuePath),r=ko.unwrap(t.value),d=require("services/datacontext"),c=function(e,n){var t=ko.utils.unwrapObservable(n);(null===t||void 0===t)&&(t="");var i=ko.virtualElements.firstChild(e);!i||3!==i.nodeType||ko.virtualElements.nextSibling(i)?ko.virtualElements.setDomNodeChildren(e,[e.ownerDocument.createTextNode(t)]):i.data=t};d.getScalarAsync(i,o+" eq '"+r+"'",a).done(function(n){c(e,n),console.log(n)})},ko.bindingHandlers.lookupText={init:bespoke.lookupText,update:bespoke.lookupText},ko.bindingHandlers.readonly={init:function(e,n){var t=$(e),i=ko.unwrap(n());i?t.prop("readonly",!0):t.prop("readonly",!1)},update:function(e,n){var t=$(e),i=ko.unwrap(n());i?t.prop("readonly",!0):t.prop("readonly",!1)}};
