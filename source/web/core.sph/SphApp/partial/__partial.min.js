...
bespoke.sph.domain.DelimitedTextFormatterPartial=function(){const e=require("durandal/system"),i=ko.observableArray(["$root"]),n=function(e){e&&i.push(e)},o=function(e){var i=this;return function(){i.DetailRowCollection.remove(e),e.nameChangedSubscription&&e.nameChangedSubscription.dispose()}},t=function(){const i=new bespoke.sph.domain.FlatFileDetailTag(e.guid());i.nameChangedSubscription=i.Name.subscribe(n),this.DetailRowCollection.push(i)},a={addDetailsRow:t,removeDetailsRow:o,parentOptions:i};return a};
