...
bespoke.sph.domain.OperationEndpointPartial=function(){var e=require("durandal/system"),n=function(e){var n=this;return function(){n.SetterActionChildCollection.remove(e)}},t=function(){var n=new bespoke.sph.domain.SetterActionChild(e.guid());n.Field({Name:ko.observable("+ Field")}),this.SetterActionChildCollection.push(n)},i=function(e){var n=this;return function(){n.PatchPathCollection.remove(e)}},o=function(){var n=new bespoke.sph.domain.PatchSetter({WebId:e.guid(),IsRequired:!0});this.PatchPathCollection.push(n)},r=function(){var e=this;require(["viewmodels/assembly.dialog","durandal/app"],function(n,t){t.showDialog(n).done(function(t){t&&"OK"===t&&_(n.selectedAssemblies()).each(function(n){e.ReferencedAssemblyCollection.push(n)})})})},a=function(e){alert("not implemented"+e)},c=function(e){var n=this;return function(){n.ReferencedAssemblyCollection.remove(e)}},s={editReferencedAssembly:a,removeReferencedAssembly:c,addReferencedAssembly:r,removePatchPath:i,addPatchPath:o,addChildAction:t,removeChildAction:n};return s};
...
bespoke.sph.domain.ReceivePortPartial=function(n){const o=ko.computed(function(){return ko.unwrap(n.Name)&&ko.unwrap(n.Formatter)&&ko.unwrap(n.Entity)});return{isWizardOk:o}};
