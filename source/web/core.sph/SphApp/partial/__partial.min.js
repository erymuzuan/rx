var bespoke=bespoke||{};bespoke.sph=bespoke.sph||{},bespoke.sph.domain=bespoke.sph.domain||{},bespoke.sph.domain.ActivityPartial=function(){var e=(require("durandal/system"),ko.observable()),o=ko.observable(!1),r=ko.observable(!1),s=ko.observable(!1),b=ko.observableArray();return{breakpoint:o,hit:s,selected:r,hasError:e,errors:b}};
...
bespoke.sph.domain.ButtonPartial=function(){var e=function(){var e=this,o=window.open("/sph/editor/ace?mode=javascript","_blank","height="+screen.height+",width="+screen.width+",toolbar=0,location=0,fullscreen=yes"),n=o.window||o,t=function(){n.code=ko.unwrap(e.Command),o.code||(o.code="//insert your code here"),n.saved=function(n,t){e.Command(n),t&&o.close()}};n.attachEvent?n.attachEvent("onload",t):t()},o=function(){var e=this,o=window.open("/sph/editor/ace?mode=javascript","_blank","height="+screen.height+",width="+screen.width+",toolbar=0,location=0,fullscreen=yes"),n=o.window||o,t=function(){n.code=ko.unwrap(e.OperationSuccessCallback),o.code||(o.code="//insert your code here"),n.saved=function(n,t){e.OperationSuccessCallback(n),t&&o.close()}};n.attachEvent?n.attachEvent("onload",t):t()},n=function(){var e=this,o=window.open("/sph/editor/ace?mode=javascript","_blank","height="+screen.height+",width="+screen.width+",toolbar=0,location=0,fullscreen=yes"),n=o.window||o,t=function(){n.code=ko.unwrap(e.OperationFailureCallback),o.code||(o.code="//insert your code here"),n.saved=function(n,t){e.OperationFailureCallback(n),t&&o.close()}};n.attachEvent?n.attachEvent("onload",t):t()},t=ko.computed(function(){});return{editCommand:e,editOperationSuccessCallback:o,editOperationFailureCallback:n,canSetSuccessCallback:t}};
...
bespoke.sph.domain.ChildWorkflowActivityPartial=function(){var e=require("durandal/system"),n=function(e){var n=this;return function(){n.PropertyMappingCollection.remove(e)}},i=function(){var n=new bespoke.sph.domain.PropertyMapping(e.guid());this.PropertyMappingCollection.push(n)},p=function(e){var n=this;return function(){n.ExecutedPropertyMappingCollection.remove(e)}},o=function(){var n=new bespoke.sph.domain.PropertyMapping(e.guid());this.ExecutedPropertyMappingCollection.push(n)},r={addExecutedMapping:o,removeExecutedMapping:p,addMapping:i,removeMapping:n};return r};
...
bespoke.sph.domain.ComplexMemberPartial=function(e){e.Name.subscribe(function(n){ko.unwrap(e.TypeName)||$.get("/entity-definition/singular/"+n).done(e.TypeName)})};
bespoke.sph.domain.ConstantFieldPartial=function(e,a){var o={Type:ko.observable(),Value:ko.observable(a.Value)};return o.Value.subscribe(function(a){ko.unwrap(e.Name)||e.Name(a)}),o};
...
bespoke.sph.domain.DelimitedTextFormatterPartial=function(){const e=require("durandal/system"),i=ko.observableArray(["$root"]),n=function(e){e&&i().indexOf(e)<0&&i.push(e)},o=function(e){var i=this;return function(){i.DetailRowCollection.remove(e),e.nameChangedSubscription&&e.nameChangedSubscription.dispose()}},t=function(){const i=new bespoke.sph.domain.FlatFileDetailTag(e.guid());i.nameChangedSubscription=i.Name.subscribe(n),this.DetailRowCollection.push(i)},a={addDetailsRow:t,removeDetailsRow:o,parentOptions:i};return a};
...
bespoke.sph.domain.MemberPartial=function(e){var o=require("durandal/system"),i=function(){this.MemberCollection.push(new bespoke.sph.domain.Member(o.guid()))},n=function(e){var o=this;return function(){require(["viewmodels/member.dialog","durandal/app"],function(i,n){var r=ko.mapping.fromJS(ko.mapping.toJS(e));i.member(r),n.showDialog(i).done(function(i){i&&"OK"===i&&o.BlockCollection.replace(e,r)})})}},r=function(e){var o=this;require(["viewmodels/field.permission.dialog","durandal/app"],function(i,n){var r=ko.mapping.fromJS(ko.mapping.toJS(e));i.member(r),n.showDialog(i).done(function(e){e&&"OK"===e&&o.FieldPermissionCollection(r.FieldPermissionCollection())})})},a=function(e){var o=this;return function(){o.MemberCollection.remove(e)}},l=function(e){var o=this;return function(){console.log("show map ",o),console.log(" on member ",e),require(["viewmodels/member.map","durandal/app"],function(i,n){i.init(o.BuildingId(),e.MemberPlanStoreId()),n.showDialog(i).done(function(o){"OK"===o&&e.MemberPlanStoreId(i.spatialStoreId())})})}},t=function(e,o,i){require(["viewmodels/"+i,"durandal/app"],function(i,n){i.field(o),n.showDialog(i).done(function(i){i&&"OK"===i&&e(o)})})},u=function(e,i){var n=new bespoke.sph.domain[i+"Field"](o.guid());t(e,n,"field."+i.toLowerCase())},d=function(e){var o=this;return function(){var i=ko.unwrap(e.$type),n=ko.mapping.fromJS(ko.mapping.toJS(e)),r=/Bespoke\.Sph\.Domain\.(.*?)Field,/,a=r.exec(i)[1];t(o.Field||o.DefaultValue,n,"field."+a.toLowerCase())}},m=function(){var e=this,o=e.Field||e.DefaultValue;return function(){o({Name:ko.observable("[Select a value]")})}};return e.AllowMultiple.subscribe(function(o){o?e.DefaultValue(null):e.DefaultValue({Name:ko.observable("[Select a value]")})}),{editPermission:r,addMember:i,editMember:n,editMemberMap:l,removeMember:a,addField:u,removeField:m,editField:d}};
...
bespoke.sph.domain.OperationEndpointPartial=function(){const e=require("durandal/system"),n=function(e){var n=this;return function(){n.SetterActionChildCollection.remove(e)}},t=function(){var n=new bespoke.sph.domain.SetterActionChild(e.guid());n.Field({Name:ko.observable("+ Field")}),this.SetterActionChildCollection.push(n)},i=function(e){var n=this;return function(){n.PatchPathCollection.remove(e)}},o=function(){var n=new bespoke.sph.domain.PatchSetter({WebId:e.guid(),IsRequired:!0});this.PatchPathCollection.push(n)},r=function(){var e=this;require(["viewmodels/assembly.dialog","durandal/app"],function(n,t){t.showDialog(n).done(function(t){t&&"OK"===t&&_(n.selectedAssemblies()).each(function(n){e.ReferencedAssemblyCollection.push(n)})})})},c=function(e){alert("not implemented"+e)},s=function(e){var n=this;return function(){n.ReferencedAssemblyCollection.remove(e)}};var a={editReferencedAssembly:c,removeReferencedAssembly:s,addReferencedAssembly:r,removePatchPath:i,addPatchPath:o,addChildAction:t,removeChildAction:n};return a};
...
bespoke.sph.domain.QueryEndpointPartial=function(e){var o=require("durandal/system"),t=function(){this.RouteParameterCollection.push(new bespoke.sph.domain.RouteParameter(o.guid()))},r=function(e){var o=this;return function(){o.RouteParameterCollection.remove(e)}},n=function(){this.FilterCollection.push(new bespoke.sph.domain.Filter(o.guid()))},i=function(e){var o=this;return function(){o.FilterCollection.remove(e)}},a=function(){this.SortCollection.push(new bespoke.sph.domain.Sort(o.guid()))},u=function(e){var o=this;return function(){o.SortCollection.remove(e)}},l=ko.observable(ko.unwrap(e.CacheFilter));return{addRouteParameter:t,removeRouteParameter:r,addSort:a,removeSort:u,addFilter:n,removeFilter:i,allowQueryCache:l}};
...
bespoke.sph.domain.ReceivePortPartial=function(e){const o=require("durandal/system"),n=ko.computed(function(){return ko.unwrap(e.Name)&&ko.unwrap(e.Formatter)&&ko.unwrap(e.Entity)}),i=function(e){var o=this;return function(){o.ReceiveLocationCollection.remove(e)}},t=function(){var e=new bespoke.sph.domain.FolderReceiveLocation({WebId:o.guid()}),n=this;require(["viewmodels/folder.receive.location.dialog","durandal/app"],function(o,i){o.location(e),i.showDialog(o).done(function(o){o&&"OK"===o&&n.ReceiveLocationCollection.push(e)})})},c=function(e){var o=this;return function(){require(["viewmodels/folder.receive.location.dialog","durandal/app"],function(n,i){var t=ko.mapping.fromJS(ko.mapping.toJS(e));n.location(t),i.showDialog(n).done(function(n){n&&"OK"===n&&o.ReceiveLocationCollection.replace(e,t)})})}},r=function(){var e=this;require(["viewmodels/assembly.dialog","durandal/app"],function(o,n){n.showDialog(o).done(function(n){n&&"OK"===n&&_(o.selectedAssemblies()).each(function(o){e.ReferencedAssemblyCollection.push(o)})})})},a=function(e){console.warn("Not implemented"+e)},l=function(e){var o=this;return function(){o.ReferencedAssemblyCollection.remove(e)}};return{editReferencedAssembly:a,removeReferencedAssembly:l,addReferencedAssembly:r,editReceiveLocation:c,removeReceiveLocation:i,addReceiveLocation:t,isWizardOk:n}};
...
bespoke.sph.domain.RouteParameterPartial=function(e){return e.Type.subscribe(function(t){"System.DateTime, mscorlib"===t&&e.DefaultValue(null)}),{}};
bespoke.sph.domain.RouteParameterFieldPartial=function(e){return e.IsOptional.subscribe(function(a){a||e.DefaultValue("")}),{}};
...
bespoke.sph.domain.TimePeriodPartial=function(n){var r=function(){return ko.unwrap(n.Count)+" "+ko.unwrap(n.Unit)};return{toString:r}};
...
bespoke.sph.domain.ValueObjectDefinitionPartial=function(){var e=require("durandal/system"),n=(require("durandal/app"),require(objectbuilders.datacontext)),o=function(){this.MemberCollection.push(new bespoke.sph.domain.Member({WebId:e.guid(),Boost:1}))},i=function(e){var n=this;return function(){n.MemberCollection.remove(e)}},r=function(e){var n=this;return function(){require(["viewmodels/member.dialog","durandal/app"],function(o,i){var r=ko.mapping.fromJS(ko.mapping.toJS(e));o.member(r),i.showDialog(o).done(function(o){o&&"OK"===o&&n.BlockCollection.replace(e,r)})})}},u=function(){var n=new bespoke.sph.domain.BusinessRule({WebId:e.guid()}),o=this;require(["viewmodels/business.rule.dialog","durandal/app"],function(e,i){e.rule(n),i.showDialog(e).done(function(e){e&&"OK"===e&&o.BusinessRuleCollection.push(n)})})},t=function(e){var o=this;return function(){require(["viewmodels/business.rule.dialog","durandal/app"],function(i,r){var u=n.toObservable(ko.mapping.toJS(e));i.rule(u),r.showDialog(i).done(function(n){n&&"OK"===n&&o.BusinessRuleCollection.replace(e,u)})})}},s=function(e){var n=this;return function(){n.BusinessRuleCollection.remove(e)}},a=function(e){var n=this;return function(){console.log("show map ",n),console.log(" on member ",e),require(["viewmodels/member.map","durandal/app"],function(o,i){o.init(n.BuildingId(),e.MemberPlanStoreId()),i.showDialog(o).done(function(n){"OK"===n&&e.MemberPlanStoreId(o.spatialStoreId())})})}};return{addMember:o,editMember:r,removeMember:i,addBusinessRule:u,editBusinessRule:t,removeBusinessRule:s,editMemberMap:a}};
