...
bespoke.sph.domain.FormDialogPartial=function(o){var n=require("durandal/system"),t=(ko.computed(function(){}),function(){o.DialogButtonCollection.push(new bespoke.sph.domain.DialogButton(n.guid()))}),i=function(n){o.DialogButtonCollection.remove(n)},e=function(o,n,t){if(t!==n){for(var i=o[n],e=n>t?-1:1,u=n;u!==t;u+=e)o[u]=o[u+e];o[t]=i}},u=function(n){var t=o.DialogButtonCollection().indexOf(n);e(o.DialogButtonCollection(),t,t+1)},l=function(n){var t=o.DialogButtonCollection().indexOf(n);e(o.DialogButtonCollection(),t,t-1)},a=ko.computed(function(){}),c=ko.computed(function(){});return{removeDialogButton:i,addDialogButton:t,moveDown:u,moveUp:l,canMoveDown:c,canMoveUp:a}};
