...
bespoke.sph.domain.ChildWorkflowActivityPartial=function(){var i=require("durandal/system"),n=function(i){var n=this;return function(){n.PropertyMappingCollection.remove(i)}},r=function(){var n=new bespoke.sph.domain.PropertyMapping(i.guid());this.PropertyMappingCollection.push(n)},e={addMapping:r,removeMapping:n};return e};
