...
bespoke.sph.domain.EntityOperationPartial=function(){var t=require("durandal/system"),e=function(t){var e=this;return function(){e.SetterActionChildCollection.remove(t)}},i=function(){var e=new bespoke.sph.domain.SetterActionChild(t.guid());e.Field({Name:ko.observable("+ Field")}),this.SetterActionChildCollection.push(e)},n=function(t){var e=this;return function(){e.SetterActionChildCollection.remove(t)}},o=function(){this.PatchPathCollection.push("")},r={removePatchPath:n,addPatchPath:o,addChildAction:i,removeChildAction:e};return r};
