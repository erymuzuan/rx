...
bespoke.sph.domain.FormDialogPartial=function(o){var n=require("durandal/system"),t=(ko.computed(function(){}),function(){o.DialogButtonCollection.push(new bespoke.sph.domain.DialogButton(n.guid()))}),i=function(n){o.DialogButtonCollection.remove(n)};return{removeDialogButton:i,addDialogButton:t}};
