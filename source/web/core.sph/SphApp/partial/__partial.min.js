...
bespoke.sph.domain.TryScopePartial=function(){var o=function(o){return function(){var c=require("durandal/system"),e=this,t=new bespoke.sph.domain.CatchScope(c.guid());require(["viewmodels/catch.scope.dialog","durandal/app"],function(c,n){c.catchScope(t),"function"==typeof c.wd&&c.wd(o()),n.showDialog(c).done(function(o){o&&"OK"===o&&e.CatchScopeCollection.push(t)})})}},c=function(){},e=function(o,c){var e=this,t=c;return function(){t().ActivityCollection().forEach(function(c){c.CatchScope()===o.Id()&&c.CatchScope("")}),e.CatchScopeCollection.remove(o)}};return{addCatchScope:o,editCatchScope:c,removeCatchScope:e}};
