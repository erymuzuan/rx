...
bespoke.sph.domain.EntityDefinitionPartial=function(){var e=require("durandal/system"),n=require(objectbuilders.datacontext),o=function(){this.MemberCollection.push(new bespoke.sph.domain.Member({WebId:e.guid(),Boost:1}))},i=function(e){var n=this;return function(){n.MemberCollection.remove(e)}},t=function(){this.EntityOperationCollection.push(new bespoke.sph.domain.EntityOperation({WebId:e.guid()}))},r=function(e){var n=this;return function(){n.EntityOperationCollection.remove(e)}},u=function(e){var n=this;return function(){require(["viewmodels/member.dialog","durandal/app"],function(o,i){var t=ko.mapping.fromJS(ko.mapping.toJS(e));o.member(t),i.showDialog(o).done(function(o){o&&"OK"==o&&n.BlockCollection.replace(e,t)})})}},s=function(){var n=new bespoke.sph.domain.BusinessRule({WebId:e.guid()}),o=this;require(["viewmodels/business.rule.dialog","durandal/app"],function(e,i){e.rule(n),i.showDialog(e).done(function(e){e&&"OK"==e&&o.BusinessRuleCollection.push(n)})})},a=function(e){var o=this;return function(){require(["viewmodels/business.rule.dialog","durandal/app"],function(i,t){var r=n.toObservable(ko.mapping.toJS(e));i.rule(r),t.showDialog(i).done(function(n){n&&"OK"==n&&o.BusinessRuleCollection.replace(e,r)})})}},l=function(e){var n=this;return function(){n.BusinessRuleCollection.remove(e)}},d=function(e){var n=this;return function(){console.log("show map ",n),console.log(" on member ",e),require(["viewmodels/member.map","durandal/app"],function(o,i){o.init(n.BuildingId(),e.MemberPlanStoreId()),i.showDialog(o).done(function(n){"OK"==n&&e.MemberPlanStoreId(o.spatialStoreId())})})}};return{addEntityOperation:t,removeEntityOperation:r,addMember:o,editMember:u,removeMember:i,addBusinessRule:s,editBusinessRule:a,removeBusinessRule:l,editMemberMap:d}};
...
bespoke.sph.domain.TryScopePartial=function(){var o=function(o,e){console.log(o),console.log(e);var n=this,l=new bespoke.sph.domain.CorrelationSet("123213213213");require(["viewmodels/correlation.set.dialog","durandal/app"],function(o,e){o.correlationSet(l),"function"==typeof o.wd&&o.wd(n),console.log("dialog"),console.log(e),console.log("app2"),console.log(e),e.showDialog(o).done(function(o){})})};return{addCatchScope:o}};
...
bespoke.sph.domain.WorkflowDefinitionPartial=function(o){var e=require("durandal/system"),n=ko.observable(!1),i=require(objectbuilders.datacontext),t=ko.observableArray(),r=function(o){var e=this;return function(){e.ActivityCollection.remove(o)}},a=function(o){var e=this;return function(){_(e.ActivityCollection()).each(function(o){o.IsInitiator(!1)}),o.IsInitiator(!0)}},l=function(o){var n=this;return function(){var i=new bespoke.sph.domain[o+"Activity"](e.guid());require(["viewmodels/activity."+o.toLowerCase(),"durandal/app"],function(o,e){o.activity(i),"function"==typeof o.wd&&o.wd(n),e.showDialog(o).done(function(o){o&&"OK"===o&&n.ActivityCollection.push(i)})})}},c=function(o){var e=this;return function(){var t=i.toObservable(ko.mapping.toJS(o)),r=ko.unwrap(o.TypeName);n(!0),require(["viewmodels/activity."+r.toLowerCase(),"durandal/app"],function(n,i){n.activity(t),"function"==typeof n.wd&&n.wd(e),i.showDialog(n).done(function(e){if($("div.modalBlockout,div.modalHost").remove(),e&&"OK"===e)for(var n in o)if(o.hasOwnProperty(n)){var i="observable"===o[n].name||"d"===o[n].name;"function"==typeof o[n]&&i?o[n](ko.unwrap(t[n])):o[n]=t[n]}})})}},u=function(o){var n=this;return function(){var i=new bespoke.sph.domain[o+"Variable"](e.guid());require(["viewmodels/variable."+o.toLowerCase(),"durandal/app"],function(o,e){o.variable(i),"function"==typeof o.wd&&o.wd(n),e.showDialog(o).done(function(o){o&&"OK"===o&&n.VariableDefinitionCollection.push(i)})})}},d=function(o){var e=this;return function(){var n=ko.unwrap(o.$type),i=ko.mapping.fromJS(ko.mapping.toJS(o)),t=/Bespoke\.Sph\.Domain\.(.*?)Variable,/,r=t.exec(n)[1];require(["viewmodels/variable."+r.toLowerCase(),"durandal/app"],function(n,t){n.variable(i),"function"==typeof n.wd&&n.wd(e),t.showDialog(n).done(function(e){if(e&&"OK"===e)for(var n in o)"function"==typeof o[n]&&"observable"===o[n].name?o[n](ko.unwrap(i[n])):o[n]=i[n]})})}},f=function(o){var e=this;return function(){e.VariableDefinitionCollection.remove(o)}},s=function(){var o=this,n=new bespoke.sph.domain.CorrelationType(e.guid());require(["viewmodels/correlation.type.dialog","durandal/app"],function(e,i){e.correlationType(n),"function"==typeof e.wd&&e.wd(o),i.showDialog(e).done(function(e){e&&"OK"===e&&o.CorrelationTypeCollection.push(n)})})},p=function(o){var e=this;return function(){var n=ko.mapping.fromJS(ko.mapping.toJS(o));require(["viewmodels/correlation.type.dialog","durandal/app"],function(i,t){i.correlationType(n),"function"==typeof i.wd&&i.wd(e),t.showDialog(i).done(function(e){if(e&&"OK"===e)for(var i in o)"function"==typeof o[i]&&"observable"===o[i].name?o[i](ko.unwrap(n[i])):o[i]=n[i]})})}},v=function(o){var e=this;return function(){e.CorrelationTypeCollection.remove(o)}},m=function(){var o=this,n=new bespoke.sph.domain.CorrelationSet(e.guid());require(["viewmodels/correlation.set.dialog","durandal/app"],function(e,i){e.correlationSet(n),"function"==typeof e.wd&&e.wd(o),i.showDialog(e).done(function(e){e&&"OK"===e&&(console.log("Adding new stuff in CorrelationSetCollection"),console.log(o.CorrelationSetCollection),o.CorrelationSetCollection.push(n))})})},w=function(o){var e=this;return function(){var n=ko.mapping.fromJS(ko.mapping.toJS(o));require(["viewmodels/correlation.set.dialog","durandal/app"],function(i,t){i.correlationSet(n),"function"==typeof i.wd&&i.wd(e),t.showDialog(i).done(function(e){if(e&&"OK"===e)for(var i in o)"function"==typeof o[i]&&"observable"===o[i].name?o[i](ko.unwrap(n[i])):o[i]=n[i]})})}},y=function(o){var e=this;return function(){e.CorrelationSetCollection.remove(o)}},h=function(){var o=this;require(["viewmodels/assembly.dialog","durandal/app"],function(e,n){n.showDialog(e).done(function(n){n&&"OK"===n&&_(e.selectedAssemblies()).each(function(e){o.ReferencedAssemblyCollection.push(e)})})})},g=function(o){alert("not implemented"+o)},b=function(o){var e=this;return function(){e.ReferencedAssemblyCollection.remove(o)}},S=function(){console.log("caling addTryScope");var o=this,n=new bespoke.sph.domain.TryScope(e.guid());require(["viewmodels/try.scope.dialog","durandal/app"],function(e,i){e.tryScope(n),"function"==typeof e.wd&&e.wd(o),i.showDialog(e).done(function(e){e&&"OK"===e&&(console.log("I just pressed Okay"),o.TryScopeCollection.push(n))})})},C=function(o){var e=this;return function(){var n=ko.mapping.fromJS(ko.mapping.toJS(o));require(["viewmodels/try.scope.dialog","durandal/app"],function(i,t){i.tryScope(n),"function"==typeof i.wd&&i.wd(e),t.showDialog(i).done(function(e){if(e&&"OK"===e)for(var i in o)"function"==typeof o[i]&&"observable"===o[i].name?o[i](ko.unwrap(n[i])):o[i]=n[i]})})}},k=function(o){var e=this;return function(){e.TryScopeCollection.remove(o)}},D=function(){var o=this,n=new bespoke.sph.domain.CorrelationSet(e.guid());require(["viewmodels/correlation.set.dialog","durandal/app"],function(e,i){e.correlationSet(n),"function"==typeof e.wd&&e.wd(o),i.showDialog(e).done(function(e){e&&"OK"===e&&(console.log("Adding new stuff in CorrelationSetCollection"),console.log(o.CorrelationSetCollection),o.CorrelationSetCollection.push(n))})})},A=function(o){var e=this;return function(){var n=ko.mapping.fromJS(ko.mapping.toJS(o));require(["viewmodels/correlation.set.dialog","durandal/app"],function(i,t){i.correlationSet(n),"function"==typeof i.wd&&i.wd(e),t.showDialog(i).done(function(e){if(e&&"OK"===e)for(var i in o)"function"==typeof o[i]&&"observable"===o[i].name?o[i](ko.unwrap(n[i])):o[i]=n[i]})})}},O=function(o){var e=this;return function(){e.CorrelationSetCollection.remove(o)}},T=function(o){var e=o||this.SchemaStoreId();$.get("/WorkflowDefinition/GetXsdElementName/"+e).then(function(o){t(o)})};o.SchemaStoreId.subscribe(T);var q={isBusy:n,removeCorrelationType:v,addCorrelationType:s,editCorrelationType:p,removeCorrelationSet:y,addCorrelationSet:m,editCorrelationSet:w,removeVariable:f,addVariable:u,editVariable:d,removeReferencedAssembly:b,addReferencedAssembly:h,editReferencedAssembly:g,addActivity:l,editActivity:c,removeActivity:r,loadSchema:T,xsdElements:t,setStartActivity:a,addTryScope:S,editTryScope:C,removeTryScope:k,addCatchScope:D,editCatchScope:A,removeCatchScope:O};return q};
