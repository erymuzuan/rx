...
bespoke.sph.domain.DelimitedTextFormatterPartial=function(){const e=require("durandal/system"),o=ko.observableArray(["[Root Record]"]),i=function(e){e&&o.push(e)},n=function(e){var o=this;return function(){o.DetailRowCollection.remove(e),e.nameChangedSubscription&&e.nameChangedSubscription.dispose()}},t=function(){const o=new bespoke.sph.domain.FlatFileDetailTag(e.guid());o.nameChangedSubscription=o.Name.subscribe(i),this.DetailRowCollection.push(o)},a={addDetailsRow:t,removeDetailsRow:n,parentOptions:o};return a};
