...
define(['services/datacontext'],
	function (context) {
	    ...
	    var isBusy = ko.observable(false),
	         adhocInvoice = ko.observable(new bespoke.sph.domain.AdhocInvoice()),
		...
		getInvoiceNo = function () {
		    ...
		    context.post(data, "/Invoice/GetAddhocInvoiceNo")
		        .then(function (result) {
		            ...
		            vm.invoice().Type(bespoke.sph.domain.InvoiceType.ADHOC_INVOICE);
        ...
        addItem = function () {
            var item = new bespoke.sph.domain.InvoiceItem();
	    ...
	    save = function () {
		    ...
		    context.post(data, "/Invoice/SaveAdhocInvoice")
		        .then(function (result) {
		            isBusy(false);
		            tcs.resolve(result);
		            vm.invoice(new bespoke.sph.domain.AdhocInvoice());
