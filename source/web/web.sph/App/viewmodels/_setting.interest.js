...
define(['services/datacontext', 'durandal/app'],
    function (context,app) {
        ...
        var isBusy = ko.observable(false),
            setting = new bespoke.sph.domain.Setting(),
            activate = function () {
            ...
            addInterest = function () {
                ...
                var interest = new bespoke.sph.domain.Interest();
        ...
        vm.selectedFloor.subscribe(function (floorname) {
            vm.isBusy(true);
            var tcs = new $.Deferred();
            context.getTuplesAsync("Space", "BuildingId eq " + vm.selectedBuildingId() + "and FloorName eq '" + floorname + "'", "SpaceId", "Category")
                .then(function (b) {
                    vm.cspaceOptions(b);
                    vm.isBusy(false);
                    tcs.resolve(true);
