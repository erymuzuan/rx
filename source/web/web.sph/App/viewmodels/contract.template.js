        ...
        var isBusy = ko.observable(false),
            activate = function(routeData) {
                ...
                if (id === 0) {
                    ...
                    template(new bespoke.sph.domain.ContractTemplate());
                    editedTopic(new bespoke.sph.domain.Topic());
                    editedClause(new bespoke.sph.domain.Clause());
            ...
            template = ko.observable(new bespoke.sph.domain.ContractTemplate()),
            ...
            addAttachment = function() {
                template().DocumentTemplateCollection.push(new bespoke.sph.domain.DocumentTemplate());
            },
            // ======================== TOPICS ============================= //
            existingTopic = null,
            editedTopic = ko.observable(new bespoke.sph.domain.Topic()),
