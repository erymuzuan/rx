...
define(['services/datacontext', 'services/logger', 'durandal/plugins/router', 'durandal/app', 'viewmodels/map', 'durandal/system'],
    function (context, logger, router, app, map, system) {
