...
define(['services/datacontext', 'services/logger', 'plugins/router'],
    function (context, logger, router) {
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
                var query = String.format("Name eq '{0}'", 'District'),
                  tcs = new $.Deferred(),
                  chartsQuery = String.format("Entity eq 'District' and IsDashboardItem eq 1"),
                  viewsQuery = String.format("EntityDefinitionId eq '5004' and IsPublished eq 1"),
                  formsQuery = String.format("EntityDefinitionId eq '5004' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                  ...
                  reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'District'"),
