...
function(context, logger, router, system, validation, eximp, dialog, watcher, config, app) {
    ...
    var entity = ko.observable(new bespoke.DevV1_product.domain.Product(system.guid())),
        ...
        activate = function(entityId) {
            ...
            context.loadOneAsync("EntityForm", "Route eq 'product-details'")
                .then(function(f) {
                form(f);
                ...
                .then(function(w) {
                watching(w);
                return $.getJSON("i18n/" + config.lang + "/product-details");
            })
                .then(function(n) {
                i18n = n[0];
        ...
        defaultCommand = function() {
            ...
            context.put(data, "/api/products/" + ko.unwrap(entity().Id) + "", headers)
        ...
        saveCommand = function() {
            return defaultCommand()
                .then(function(result) {
                if (result.success) {
                    return app.showMessage("Your product has been saved", ["OK"]);
                } else {
                    return Task.fromResult(false);
                }
            })
