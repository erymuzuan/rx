        ...
        var isBusy = ko.observable(false),
            ...
            activate = function (mrn) {
                ...
                var edQuery = String.format("Name eq '{0}'", 'Appointment'),
                    tcs = new $.Deferred(),
                    formsQuery = String.format("EntityDefinitionId eq 6003 and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                    viewQuery = String.format("EntityDefinitionId eq 6003"),
            ...
            attached = function () {
                chart.init('Appointment', query, chartSeriesClick, 7005);
            };
