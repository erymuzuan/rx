...
define(['services/datacontext', 'services/logger', 'plugins/router'],
    function (context, logger, router) {
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
                var query = String.format("Name eq '{0}'", 'Invoice'),
                  tcs = new $.Deferred(),
                  chartsQuery = String.format("Entity eq 'Invoice' and IsDashboardItem eq 1"),
                  formsQuery = String.format("EntityDefinitionId eq '7003' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                  ...
                  reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'Invoice'"),
                  viewsTask = $.get("/Sph/EntityView/Dashboard/Invoice");
