...
define(["services/datacontext", "services/logger", "plugins/router", "services/chart", objectbuilders.config , "partial/appointments-all"],
    function (context, logger, router, chart,config , partial) {
        ...
        var isBusy = ko.observable(false),
            ...
            chartSeriesClick = function(e) {
                ...
                context.searchAsync("Appointment", q)
                    .done(function (lo) {
            ...
            attached = function (view) {
                chart.init("Appointment", query, chartSeriesClick, "appointments-all");
