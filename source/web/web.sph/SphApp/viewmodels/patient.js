    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'Patient'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'Patient' and IsDashboardItem eq true"),
                formsQuery = String.format("EntityDefinitionId eq 'patient' and IsPublished eq true and IsAllowedNewItem eq true"),
