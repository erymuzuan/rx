...
define(['services/datacontext', 'services/logger', 'plugins/router'],
    function (context, logger, router) {
        ...
        var isBusy = ko.observable(false),
            ...
            activate = function () {
                var query = String.format("Name eq '{0}'", 'Permohonan'),
                  tcs = new $.Deferred(),
                  viewsQuery = String.format("EntityDefinitionId eq '2' and IsPublished eq 1"),
                  formsQuery = String.format("EntityDefinitionId eq '2' and IsPublished eq 1 and IsAllowedNewItem eq 1"),
                  edTask = context.loadOneAsync("EntityDefinition", query),
                  formsTask = context.loadAsync("EntityForm", formsQuery),
                  reportTask = context.loadAsync("ReportDefinition", "[DataSource.EntityName] eq 'Permohonan'"),
