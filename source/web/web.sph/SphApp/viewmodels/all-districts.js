    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            ...
            var edQuery = String.format("Name eq '{0}'", 'District'),
                tcs = new $.Deferred(),
                formsQuery = String.format("EntityDefinitionId eq 'district' and IsPublished eq true and IsAllowedNewItem eq true"),
        ...
        attached = function(view) {
            chart.init("District", query, chartSeriesClick, "district-all-districts");
        },
