    ...
    var isBusy = ko.observable(false),
        ...
        activate = function() {
            var query = String.format("Name eq '{0}'", 'Customer'),
                tcs = new $.Deferred(),
                chartsQuery = String.format("Entity eq 'Customer' and IsDashboardItem eq true"),
                formsQuery = String.format("EntityDefinitionId eq 'customer' and IsPublished eq true and IsAllowedNewItem eq true"),
