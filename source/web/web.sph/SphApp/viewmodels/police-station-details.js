...
function(context, logger, router, system, validation, eximp, dialog, watcher, config, app) {
    ...
    var entity = ko.observable(new bespoke.DevV1_policeStation.domain.PoliceStation(system.guid())),
        ...
        activate = function(entityId) {
            ...
            context.loadOneAsync("EntityForm", "Route eq 'police-station-details'")
                .then(function(f) {
                form(f);
                ...
                .then(function(w) {
                watching(w);
                return $.getJSON("i18n/" + config.lang + "/police-station-details");
            })
                .then(function(n) {
                i18n = n[0];
        ...
        defaultCommand = function() {
            ...
            context.post(data, "/api/police-stations/", headers)
        ...
        attached = function(view) {
            // validation
            validation.init($('#police-station-details-form'), form());
        ...
        saveCommand = function() {
            return defaultCommand()
                .then(function(result) {
                if (result.success) {
                    return app.showMessage("Dah berjaya", ["OK"]);
                } else {
                    return Task.fromResult(false);
                }
            })
