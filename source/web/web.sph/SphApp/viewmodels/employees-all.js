    ...
    function (context, logger, router, chart,config) {
        ...
        var isBusy = ko.observable(false),
            ...
            chartSeriesClick = function(e) {
                ...
                context.searchAsync("Employee", q)
                    .done(function (lo) {
            ...
            attached = function () {
                chart.init("Employee", query, chartSeriesClick, "550a1834-29ff-4ce8-8989-88c96a75c7c3");
            },
