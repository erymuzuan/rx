...
bespoke.sphcommercialspace.domain.BarChartItemPartial = function () {
    var system = require('durandal/system'),
        addSeries = function() {
            this.ChartSeriesCollection.push(new bespoke.sphcommercialspace.domain.ChartSeries(system.guid()));
        },
