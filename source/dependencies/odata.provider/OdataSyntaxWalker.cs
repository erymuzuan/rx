...
{
    public abstract class OdataSyntaxWalker
    {
        ...
        public OdataSyntaxWalker[] Walkers { get; set; }

        public CSharpCompilation Compilation { get; set; }
        public SyntaxTree[] Trees { get; set; }
        public CSharpSyntaxTree Snippet { get; set; }
        public OdataSyntaxWalker Compiler { get; set; }
        ...
        protected OdataSyntaxWalker GetWalker(SymbolInfo symbol, bool excludeThis = false)
        {
        ...
        protected OdataSyntaxWalker GetWalker(SyntaxNode node, bool excludeThis = false)
        {
            var potentialWalkers = this.Walkers
        ...
        public class Comparer : IEqualityComparer<OdataSyntaxWalker>
        {
            public bool Equals(OdataSyntaxWalker x, OdataSyntaxWalker y)
            {
                return x.GetType() == y.GetType();
            }

            public int GetHashCode(OdataSyntaxWalker obj)
            {
