    ...
    function (context, jquery, app, system, logger, db) {
        var list = ko.observableArray(),
            ...
            vm = {
                ...
                online: online,
                list: list,
                entity: ko.observable(new bespoke.@(Model.ApplicationName)_@(Model.Definition.EntityDefinitionId).domain.@(Model.Name)({ WebId: system.guid() })),
                sendOperation: send
            };
