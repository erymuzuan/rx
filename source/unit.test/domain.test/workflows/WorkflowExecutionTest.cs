...
namespace domain.test.workflows
{
    ...
    public class WorkflowExecutionTest
    {
        ...
        public void CompileAndRun()
        {
            ...
            var dll = wd.Compile(Path.GetFullPath(@"\project\work\sph\source\web\web.sph\bin\System.Web.Mvc.dll"),
                Path.GetFullPath(@"\project\work\sph\source\web\web.sph\bin\web.sph.dll"));
