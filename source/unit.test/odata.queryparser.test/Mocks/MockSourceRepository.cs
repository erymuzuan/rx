...
namespace Bespoke.Sph.ODataQueryParserTests
{
    internal class MockSourceRepository : ISourceRepository
    {
        ...
        public Task SavedAsync<T>(T project, IEnumerable<AttachedProperty> properties)
            where T : Entity, IProjectDefinition
        {
            throw new NotImplementedException();
        }

        public Task<IEnumerable<AttachedProperty>> GetAttachedPropertiesAsync<T>(IProjectBuilder builder, T project)
            where T : Entity, IProjectDefinition
        {
            throw new NotImplementedException();
        }
        ...
        public Task<IEnumerable<AttachedProperty>> GetAttachedPropertiesAsync<T>(IProjectBuilder builder, T project,
            Member member) where T : Entity, IProjectDefinition
        {
            throw new NotImplementedException();
        }
