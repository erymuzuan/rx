...
SET RX_DEVV1_RabbitMqBase=E:\project\work\rx\bin\rabbitmq_base
SET RX_DEVV1_ElasticsearchIndexNumberOfShards=1
SET RX_DEVV1_IisExpressExecutable=E:\project\work\rx\bin\IIS Express\iisexpress.exe
SET RX_DEVV1_ElasticsearchHttpPort=9200
SET RX_DEVV1_ElasticSearchJar=E:\project\work\rx\bin\elasticsearch\lib\elasticsearch-1.7.5.jar
...
SET RX_DEVV1_RabbitMqDirectory=E:\project\work\rx\bin\rabbitmq_server
...
SET RABBITMQ_BASE=E:\project\work\rx\bin\control.center\rabbitmq_base
