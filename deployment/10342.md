...
* dead.letter.viewere.exe

### New features
When decompressing a message from `dead-letter-queue`, corrensponding log entry will also fetched as displayed in `Log entry` tab, in your property window 
