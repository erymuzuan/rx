    ...
    [{description,"RabbitMQ"},
     ...
     {modules,
         [app_utils,background_gc,credit_flow,delegate,delegate_sup,dtree,
          ...
          rabbit_plugins_usage,rabbit_policy,rabbit_policy_validator,
          rabbit_prelaunch,rabbit_queue_collector,rabbit_queue_index,
          rabbit_reader,rabbit_registry,rabbit_restartable_sup,rabbit_router,
