...
{
    public partial class VanController : System.Web.Mvc.Controller
    {
        //exec:Search
        ...
        //exec:Save
        public async Task<System.Web.Mvc.ActionResult> Save([RequestBody]Van item)
        {
            ...
            this.Response.ContentType = "application/json; charset=utf-8";
            return Json(new { success = true, status = "OK", id = item.Id, href = "van/" + item.Id });
        }
        //exec:validate
        [HttpPost]
        public async Task<System.Web.Mvc.ActionResult> Validate(string id, [RequestBody]Van item)
        {
            var context = new Bespoke.Sph.Domain.SphDataContext();
            if (null == item) throw new ArgumentNullException("item");
            var ed = await context.LoadOneAsync<EntityDefinition>(d => d.Name == "Van");
        ...
        public async Task<System.Web.Mvc.ActionResult> Remove(string id)
        {
            ...
            var repos = ObjectBuilder.GetObject<IRepository<Van>>();
        ...
        public async Task<System.Web.Mvc.ActionResult> Schemas()
        {
            ...
            var ed = await context.LoadOneAsync<EntityDefinition>(t => t.Name == "Van");
