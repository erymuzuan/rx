...
namespace Bespoke.DevV1_vehicle.Domain
{
    public partial class VehicleController : System.Web.Mvc.Controller
    {
        ...
        //exec:Save
        public async Task<System.Web.Mvc.ActionResult> Save([RequestBody]Vehicle item)
        {
            ...
            this.Response.ContentType = "application/json; charset=utf-8";
            return Json(new { success = true, status = "OK", id = item.Id, href = "vehicle/" + item.Id });
        }
        //exec:validate
        [HttpPost]
        public async Task<System.Web.Mvc.ActionResult> Validate(string id, [RequestBody]Vehicle item)
        {
            var context = new Bespoke.Sph.Domain.SphDataContext();
            if (null == item) throw new ArgumentNullException("item");
            var ed = await context.LoadOneAsync<EntityDefinition>(d => d.Name == "Vehicle");
        ...
        public async Task<System.Web.Mvc.ActionResult> Remove(string id)
        {
            ...
            var repos = ObjectBuilder.GetObject<IRepository<Vehicle>>();
        ...
        public async Task<System.Web.Mvc.ActionResult> Schemas()
        {
            ...
            var ed = await context.LoadOneAsync<EntityDefinition>(t => t.Name == "Vehicle");
