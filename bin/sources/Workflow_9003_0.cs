...
namespace Bespoke.Sph.Workflows_9003_0
{
   [EntityType(typeof(Workflow))]
   public class MyScheduledWorkflow_9003_0 : Bespoke.Sph.Domain.Workflow
   {
       public MyScheduledWorkflow_9003_0()
       {
           this.Name = "My scheduled workflow";
           this.Version = 0;
           this.WorkflowDefinitionId = 9003;
           this.app = new Applicant();
       }
       public override Task<ActivityExecutionResult> StartAsync()
       {
           this.SerializedDefinitionStoreId = "wd.9003.0";
...
//exec:ee090c8f-ac80-4444-a882-837dd81ecac4
   ...
   public partial class Workflow_9003_0Controller : System.Web.Mvc.Controller
{
//exec:ee090c8f-ac80-4444-a882-837dd81ecac4
       public async Task<System.Web.Mvc.ActionResult> Screen4(int id, string correlation)
       {
           ...
           var vm = new Screen4ViewModel(){
                   Screen  = screen,
                   Instance  = wf as MyScheduledWorkflow_9003_0,
...
//exec:ee090c8f-ac80-4444-a882-837dd81ecac4
       ...
       {
           var wf = Bespoke.Sph.Web.Helpers.ControllerHelpers.GetRequestJson<MyScheduledWorkflow_9003_0>(this);
   ...
   {
       public MyScheduledWorkflow_9003_0 Instance {get;set;}
...
//exec:Search
       public async Task<System.Web.Mvc.ActionResult> Search()
       {
            ...
            var url = string.Format("{0}/{1}/workflow_9003_0/_search", ConfigurationManager.ElasticSearchHost, ConfigurationManager.ElasticSearchIndex );
...
//exec:Schemas
       ...
       {
           var store = ObjectBuilder.GetObject<IBinaryStore>();
           var doc = await store.GetContentAsync("wd.9003.0");
