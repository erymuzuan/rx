...
{
    public partial class TelephoneController : System.Web.Mvc.Controller
    {
        //exec:Search
        public async Task<System.Web.Mvc.ActionResult> Search()
        {
            ...
            var url = "devv1/telephone/_search";
        ...
        //exec:Save
        public async Task<System.Web.Mvc.ActionResult> Save([RequestBody]Telephone item)
        {
            ...
            this.Response.ContentType = "application/json; charset=utf-8";
            return Json(new { success = true, status = "OK", id = item.Id, href = "telephone/" + item.Id });
        }
        //exec:validate
        [HttpPost]
        public async Task<System.Web.Mvc.ActionResult> Validate(string id, [RequestBody]Telephone item)
        {
            var context = new Bespoke.Sph.Domain.SphDataContext();
            if (null == item) throw new ArgumentNullException("item");
            var ed = await context.LoadOneAsync<EntityDefinition>(d => d.Name == "Telephone");
        ...
        public async Task<System.Web.Mvc.ActionResult> Remove(string id)
        {
            ...
            var repos = ObjectBuilder.GetObject<IRepository<Telephone>>();
        ...
        public async Task<System.Web.Mvc.ActionResult> Schemas()
        {
            ...
            var ed = await context.LoadOneAsync<EntityDefinition>(t => t.Name == "Telephone");
