...
namespace Bespoke.Sph.Workflows_7002_0
{
   [EntityType(typeof(Workflow))]
   public class TestXXX1234_7002_0 : Bespoke.Sph.Domain.Workflow
   {
       public TestXXX1234_7002_0()
       {
           this.Name = "Test XXX1234";
           this.Version = 0;
       ...
       {
           this.SerializedDefinitionStoreId = "wd.7002.0";
...
//exec:af52a115-7edc-44e7-a59d-ff5703514087
   ...
   public partial class Workflow_7002_0Controller : System.Web.Mvc.Controller
{
//exec:8655a85e-caea-4bd0-a498-157f0c032f54
       public async Task<System.Web.Mvc.ActionResult> Screen0()
       {
           var context = new SphDataContext();
           var wf =  new  TestXXX1234_7002_0();
           ...
           var vm = new Screen0ViewModel(){
                   Screen  = screen,
                   Instance  = wf as TestXXX1234_7002_0,
...
//exec:8655a85e-caea-4bd0-a498-157f0c032f54
       ...
       {
           var wf = Bespoke.Sph.Web.Helpers.ControllerHelpers.GetRequestJson<TestXXX1234_7002_0>(this);
   ...
   {
       public TestXXX1234_7002_0 Instance {get;set;}
...
//exec:Search
       public async Task<System.Web.Mvc.ActionResult> Search()
       {
            ...
            var url = string.Format("{0}/{1}/workflow_7002_0/_search", ConfigurationManager.ElasticSearchHost, ConfigurationManager.ElasticSearchIndex );
...
//exec:Schemas
       ...
       {
           var store = ObjectBuilder.GetObject<IBinaryStore>();
           var doc = await store.GetContentAsync("wd.7002.0");
