"C:\Program Files\Internet Explorer\iexplore.exe" "http://localhost:4437/asp.netwebadminfiles/default.aspx?applicationPhysicalPath=c:\project\work\sph\source\web\web.sph&applicationUrl=/"
